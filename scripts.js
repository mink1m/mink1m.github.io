...
imported from: http://d17ol771963kd3.cloudfront.net/assets/application-e700ee60c4e58a7780ed40b0893d3f49.js

  for site animations and real-time date

inefficient; work on trimming 
...
(window.Modernizr = (function (e, t, n) {
  ...
  function M(e, t, n) {
    ...
    return k(t, "string") || k(t, "undefined")
      ? A(i, t)
      : ((i = (e + " " + v.join(r + " ") + r).split(" ")), O(i, t, n));
  }
  var r = "2.6.2",
    i = {},
    s = !0,
    ...
    x = {}.hasOwnProperty,
    T;
  !k(x, "undefined") && !k(x.call, "undefined")
    ? (T = function (e, t) {
        return x.call(e, t);
      })
    : (T = function (e, t) {
  ...
  for (var _ in m)
    T(m, _) &&
      ((E = _.toLowerCase()), (i[E] = m[_]()), b.push((i[E] ? "" : "no-") + E));
  return (
    (i.addTest = function (e, t) {
      if (typeof e == "object") for (var r in e) T(e, r) && i.addTest(r, e[r]);
      else {
        e = e.toLowerCase();
        if (i[e] !== n) return i;
    ...
    (function (e, t) {
      ...
      function p(e, n, s) {
        ...
        return (
          s.cache[e]
            ? (o = s.cache[e].cloneNode())
            : i.test(e)
            ? (o = (s.cache[e] = s.createElem(e)).cloneNode())
            : (o = s.createElem(e)),
  ...
  (function (e, t) {
    ...
    function On(e, t) {
      ...
      for (; (i = o[++f]); )
        if (i !== "*") {
          if (u !== "*" && u !== i) {
            if (e.crossDomain && i === "script") continue;
            n = a[u + " " + i] || a["* " + i];
            if (!n)
              for (r in a) {
                s = r.split(" ");
        ...
        ajax: function (e, n) {
          ...
          d.promise(x),
            ...
            (c.dataTypes = v
              ...
              .split(y)),
            c.crossDomain == null &&
              ((a = wn.exec(c.url.toLowerCase()) || !1),
              (c.crossDomain =
                a &&
                a.join(":") + (a[3] ? "" : a[1] === "http:" ? 80 : 443) !==
                  ln.join(":") + (ln[3] ? "" : ln[1] === "http:" ? 80 : 443))),
            c.data &&
              c.processData &&
    ...
    (e.rails = r =
      {
        ...
        handleRemote: function (n) {
          ...
          if (r.fire(n, "ajax:before")) {
            (u = n.data("cross-domain")),
              ...
              (l =
                n.data("type") || (e.ajaxSettings && e.ajaxSettings.dataType));
            if (n.is("form")) {
              (i = n.attr("method")),
                (s = n.attr("action")),
                (o = n.serializeArray());
              ...
              n.is(r.inputChangeSelector)
                ? ((i = n.data("method")),
                  (s = n.data("url")),
                  (o = n.serialize()),
                  n.data("params") && (o = o + "&" + n.data("params")))
                : ((i = n.data("method")),
                  (s = r.href(n)),
        ...
        allowAction: function (e) {
          ...
          return t
            ? (r.fire(e, "confirm") &&
                ((n = r.confirm(t)), (i = r.fire(e, "confirm:complete", [n]))),
              n && i)
            : !0;
        },
          ...
          return (
            a.each(function () {
              ...
              if (!o == !r) {
                if (
                  s.is(":radio") &&
                  a.filter('input:radio:checked[name="' + s.attr("name") + '"]')
                    .length
                )
                  return !0;
                i = i.add(s);
      ...
      r.fire(e(document), "rails:attachBindings") &&
        ...
        e(document).delegate(
          ...
          function (t) {
            var n = e(this);
            return r.allowAction(n)
              ? (r.handleRemote(n), !1)
              : r.stopEverything(t);
          }
        ),
        e(document).delegate(
          r.formSubmitSelector,
          "submit.rails",
          function (n) {
            var i = e(this),
              s = i.data("remote") !== t,
            ...
            if (
              o &&
              i.attr("novalidate") == t &&
              r.fire(i, "ajax:aborted:required", [o])
            )
            ...
            if (s) {
              ...
              return !e.support.submitBubbles &&
                e().jquery < "1.7" &&
                r.callFormSubmitBindings(i, n) === !1
                ? r.stopEverything(n)
                : (r.handleRemote(i), !1);
            }
            setTimeout(function () {
  ...
  function () {
    ...
    (e =
      ...
      (n = function () {
        var n, r, i, s;
        s = [];
        for (r = 0, i = t.length; r < i; r++) (n = t[r]), s.push(n(e));
        return s;
      }),
      e(n),
  ...
  (function (e, t) {
    ...
    e.fn.imagesLoaded = function (r) {
      ...
      function h(t, r) {
        ...
        a.push(t),
          r ? l.push(t) : f.push(t),
          e.data(t, "imagesLoaded", { isBroken: r, src: t.src }),
          o && s.notifyWith(e(t), [r, u, e(f), e(l)]),
          u.length === a.length && (setTimeout(c), u.unbind(".imagesLoaded"));
      }
      var i = this,
  ...
  (jwplayer.version = "5.10.2295 (Licensed version)"),
    ...
    (function (e) {
      ...
      (e.utils = function () {}),
        (e.utils.typeOf = function (e) {
          ...
          return (
            t === "object" &&
              (e ? e instanceof Array && (t = "array") : (t = "null")),
            t
          );
        }),
                ...
                if (i.status === 200) {
                  if (n) {
                    if (!e.utils.exists(i.responseXML))
                      try {
                        if (window.DOMParser) {
                          var s = new DOMParser().parseFromString(
                            i.responseText,
                            "text/xml"
                          );
                          ...
                          (s = new ActiveXObject("Microsoft.XMLDOM")),
                            ...
                            (i = e.utils.extend({}, i, { responseXML: s }));
                      } catch (o) {
                        r && r(t);
                      }
                    n(i);
        ...
        (e.utils.getFirstPlaylistItemFromConfig = function (e) {
          var t = {},
            n;
          return (
            e.playlist && e.playlist.length ? (n = e.playlist[0]) : (n = e),
            (t.file = n.file),
            (t.levels = n.levels),
            ...
            t.provider ||
              (t.file &&
                (t.file.toLowerCase().indexOf("youtube.com") > -1 ||
                  t.file.toLowerCase().indexOf("youtu.be") > -1) &&
                (t.provider = "youtube"),
              t.streamer &&
                t.streamer.toLowerCase().indexOf("rtmp://") == 0 &&
                (t.provider = "rtmp"),
        ...
        (e.utils.getPluginName = function (e) {
          return (
            ...
            e.lastIndexOf(".swf") >= 0 &&
              (e = e.substring(0, e.lastIndexOf(".swf"))),
            e.lastIndexOf(".js") >= 0 &&
        ...
        (e.utils.getPluginVersion = function (e) {
          return e.lastIndexOf("-") >= 0
            ? e.lastIndexOf(".js") >= 0
              ? e.substring(e.lastIndexOf("-") + 1, e.lastIndexOf(".js"))
              : e.lastIndexOf(".swf") >= 0
              ? e.substring(e.lastIndexOf("-") + 1, e.lastIndexOf(".swf"))
        ...
        (e.utils.getAbsolutePath = function (n, r) {
          ...
          if (t(n)) return n;
          var i = r.substring(0, r.indexOf("://") + 3),
            s = r.substring(i.length, r.indexOf("/", i.length + 1)),
            o;
          if (n.indexOf("/") === 0) o = n.split("/");
          else {
            var u = r.split("?")[0];
        ...
        (e.utils.getPluginPathType = function (t) {
          ...
          return n < 0 && r < 0 && (!i || !isNaN(i))
            ? e.utils.pluginPathType.CDN
            ...
            for (var i in n)
              try {
                ...
                if (
                  ...
                  i.match(/color/i)
                    ? (n[i] = "#" + e.utils.strings.pad(n[i].toString(16), 6))
                    : (n[i] = Math.ceil(n[i]) + "px");
                }
                t.style[i] = n[i];
              } catch (s) {}
        }),
        ...
        (e.utils.stretch = function (t, n, r, i, s, o) {
          ...
          switch (t.toUpperCase()) {
            ...
            case e.utils.stretching.FILL:
              u > a
                ? ((h.width = s * u), (h.height = o * u))
                : ((h.width = s * a), (h.height = o * a)),
                (h.top = (i - h.height) / 2),
                (h.left = (r - h.width) / 2);
              break;
        ...
        (e.utils.getElementWidth = function (t) {
          return t
            ? t == document.body
              ? e.utils.parentNode(t).clientWidth
              : t.clientWidth > 0
              ? t.clientWidth
              : t.style
              ? e.utils.parseDimension(t.style.width)
              : null
            : null;
        }),
        (e.utils.getElementHeight = function (t) {
          return t
            ? t == document.body
              ? e.utils.parentNode(t).clientHeight
              : t.clientHeight > 0
              ? t.clientHeight
              : t.style
              ? e.utils.parseDimension(t.style.height)
              : null
            : null;
        }),
        ...
        (e.utils.getBoundingClientRect = function (e) {
          return typeof e.getBoundingClientRect == "function"
        ...
        (e.utils.translateEventResponse = function (t, n) {
          ...
          t == e.api.events.JWPLAYER_FULLSCREEN && !r.fullscreen
            ? ((r.fullscreen = r.message == "true" ? !0 : !1), delete r.message)
            : typeof r.data == "object"
            ? ((r = e.utils.extend(r, r.data)), delete r.data)
            : typeof r.metadata == "object" &&
              e.utils.deepReplaceKeyName(
                r.metadata,
        ...
        (e.utils.getCookies = function () {
          ...
          for (var n = 0; n < t.length; n++) {
            var r = t[n].split("=");
            r[0].indexOf("jwplayer.") == 0 &&
              (e[r[0].substring(9, r[0].length)] = r[1]);
          }
          return e;
        }),
      ...
      jwplayer.events.eventdispatcher = function (debug) {
        ...
        (this.resetEventListeners = function () {
          ...
          (this.addEventListener = function (type, listener, count) {
            try {
              jwplayer.utils.exists(_listeners[type]) ||
                (_listeners[type] = []),
                ...
                try {
                  ...
                  jwplayer.utils.log(
                    "There was an error while handling a listener: " +
                      r.toString(),
                    _listeners[e][n].listener
                  );
                }
                _listeners[e][n] &&
                  (_listeners[e][n].count === 1
                    ? delete _listeners[e][n]
                    : _listeners[e][n].count > 0 &&
                      (_listeners[e][n].count = _listeners[e][n].count - 1));
              }
            for (var i = 0; i < _globallisteners.length; i++) {
              try {
                ...
                jwplayer.utils.log(
                  "There was an error while handling a listener: " +
                    r.toString(),
                  _globallisteners[i].listener
                );
              }
              _globallisteners[i] &&
                (_globallisteners[i].count === 1
                  ? delete _globallisteners[i]
                  : _globallisteners[i].count > 0 &&
                    (_globallisteners[i].count =
                      _globallisteners[i].count - 1));
            }
          });
      };
      ...
      (e.utils.animations = function () {}),
        ...
        (e.utils.fadeTo = function (n, r, i, s, o, u) {
          ...
          u > f &&
            ...
            e.utils.exists(s) ||
              (s = n.style.opacity === "" ? 1 : n.style.opacity);
          if (
            n.style.opacity == r &&
            n.style.opacity !== "" &&
            e.utils.exists(u)
    ...
    (function (e) {
      ...
      function s(t, n) {
        ...
        var l = i(t, n);
        return (
          e.utils.exists(l.file) && (s[0] = { file: l.file }), (l.levels = s), l
        );
      }
      function o(e, t) {
        t = r("source", t);
      ...
      (e.utils.selectors = function (t, n) {
        ...
        if (r == ".")
          return n.getElementsByClassName
            ? n.getElementsByClassName(t.substr(1))
            : e.utils.selectors.getElementsByTagAndClass("*", t.substr(1));
        if (t.indexOf(".") > 0) {
          var i = t.split(".");
      ...
      (e.utils.strings = function () {}),
        ...
        (e.utils.strings.serialize = function (e) {
          return e == null
            ...
            : e == "false"
            ? !1
            : isNaN(Number(e)) || e.length > 5 || e.length == 0
            ? e
            : Number(e);
        }),
        (e.utils.strings.seconds = function (e) {
          ...
          return (
            e.substr(-1) == "s"
              ? (n = Number(e.substr(0, e.length - 1)))
              : e.substr(-1) == "m"
              ? (n = Number(e.substr(0, e.length - 1)) * 60)
              : e.substr(-1) == "h"
              ? (n = Number(e.substr(0, e.length - 1)) * 3600)
              : t.length > 1
              ? ((n = Number(t[t.length - 1])),
                (n += Number(t[t.length - 2]) * 60),
                t.length == 3 && (n += Number(t[t.length - 3]) * 3600))
              : (n = Number(e)),
            n
          );
        }),
        ...
        (e.utils.strings.jsonToString = function (t) {
          ...
          if (r == "object" && t !== null) {
            ...
            for (var o in t) {
              ...
              s
                ? typeof u != "function" && i.push(String(u))
                : typeof u != "function" && i.push('"' + o + '":' + String(u));
            }
    ...
    (function (e) {
      function n(e) {
        ...
        return n.toString().indexOf(e.toLowerCase().replace(" ", "")) >= 0
          ? "boolean"
          : t.test(e)
          ? "color"
          : !isNaN(parseInt(e, 10)) &&
            parseInt(e, 10).toString().length == e.length
          ? "integer"
          : !isNaN(parseFloat(e)) && parseFloat(e).toString().length == e.length
          ? "float"
          : "string";
      }
      function r(t, n) {
      ...
      function i(e) {
        switch (e.toLowerCase()) {
          ...
          default:
            return (
              (e = e.replace(/(#|0x)?([0-9A-F]{3,6})$/gi, "$2")),
              e.length == 3 &&
                (e =
                  e.charAt(0) +
                  e.charAt(0) +
      ...
      (e.utils.parsers.jwparser = function () {}),
        ...
        (e.utils.parsers.jwparser.parseEntry = function (t, n) {
          for (var r = 0; r < t.childNodes.length; r++)
            t.childNodes[r].prefix == e.utils.parsers.jwparser.PREFIX &&
              ((n[e.utils.parsers.localName(t.childNodes[r])] =
                e.utils.strings.serialize(
                  e.utils.parsers.textContent(t.childNodes[r])
                )),
              e.utils.parsers.localName(t.childNodes[r]) == "file" &&
                n.levels &&
                delete n.levels),
              !n.file &&
                String(n.link).toLowerCase().indexOf("youtube") > -1 &&
                (n.file = n.link);
          return n;
        }),
        (e.utils.parsers.jwparser.getProvider = function (t) {
          ...
          if (
            t.file.indexOf("youtube.com/w") > -1 ||
            t.file.indexOf("youtube.com/v") > -1 ||
            t.file.indexOf("youtu.be/") > -1
          )
            return "youtube";
        ...
        (e.utils.parsers.mediaparser.parseGroup = function (t, n) {
          ...
          for (var i = 0; i < t.childNodes.length; i++)
            if (t.childNodes[i].prefix == e.utils.parsers.mediaparser.PREFIX) {
              ...
              switch (
                e.utils.parsers.localName(t.childNodes[i]).toLowerCase()
              ) {
                case "content":
                  r ||
                    (n.file = e.utils.strings.xmlAttribute(
                      t.childNodes[i],
                      "url"
                    )),
                    e.utils.strings.xmlAttribute(t.childNodes[i], "duration") &&
                      (n.duration = e.utils.strings.seconds(
                        e.utils.strings.xmlAttribute(
                          t.childNodes[i],
                          "duration"
                        )
                      )),
                    e.utils.strings.xmlAttribute(t.childNodes[i], "start") &&
                      (n.start = e.utils.strings.seconds(
                        e.utils.strings.xmlAttribute(t.childNodes[i], "start")
                      )),
                    t.childNodes[i].childNodes &&
                      t.childNodes[i].childNodes.length > 0 &&
                      (n = e.utils.parsers.mediaparser.parseGroup(
                        t.childNodes[i],
                        n
                      ));
                  if (
                    e.utils.strings.xmlAttribute(t.childNodes[i], "width") ||
                    e.utils.strings.xmlAttribute(t.childNodes[i], "bitrate") ||
                    e.utils.strings.xmlAttribute(t.childNodes[i], "url")
                  )
                    n.levels || (n.levels = []),
                      n.levels.push({
                        width: e.utils.strings.xmlAttribute(
                          t.childNodes[i],
                          "width"
                        ),
                        bitrate: e.utils.strings.xmlAttribute(
                          t.childNodes[i],
                          "bitrate"
                        ),
                        file: e.utils.strings.xmlAttribute(
                          t.childNodes[i],
                          "url"
                        ),
                      });
                ...
                case "keywords":
                  ...
                  break;
                case "thumbnail":
                  n.image = e.utils.strings.xmlAttribute(
                    t.childNodes[i],
                    "url"
                  );
                  break;
                ...
                case "player":
                  ...
                  if (
                    s.indexOf("youtube.com") >= 0 ||
                    s.indexOf("youtu.be") >= 0
                  )
                    (r = !0),
                      (n.file = e.utils.strings.xmlAttribute(
                        t.childNodes[i],
    ...
    (function (e) {
      function t(t) {
        ...
        return (
          (n = e.utils.parsers.mediaparser.parseGroup(t, n)),
      ...
      (e.utils.parsers.rssparser = function () {}),
        (e.utils.parsers.rssparser.parse = function (n) {
          ...
          for (var i = 0; i < n.childNodes.length; i++)
            if (
              e.utils.parsers.localName(n.childNodes[i]).toLowerCase() ==
              "channel"
            )
              for (var s = 0; s < n.childNodes[i].childNodes.length; s++)
                e.utils.parsers
                  .localName(n.childNodes[i].childNodes[s])
                  .toLowerCase() == "item" &&
                  r.push(t(n.childNodes[i].childNodes[s]));
          return r;
        });
    })(jwplayer),
    (function (e) {
      ...
      (e.plugins = function () {}),
        (e.plugins.loadPlugins = function (r, i) {
          return (
            (n[r] = new e.plugins.pluginloader(new e.plugins.model(t), i)), n[r]
          );
        }),
        (e.plugins.registerPlugin = function (r, i, s) {
          var o = e.utils.getPluginName(r);
          if (t[o]) t[o].registerPlugin(r, i, s);
          else {
            e.utils.log(
              "A plugin (" +
                r +
    ...
    (function (e) {
      (e.plugins.pluginmodes = {
        ...
        (e.plugins.plugin = function (t) {
          ...
          var n = "http://lp.longtailvideo.com",
            r = e.utils.loaderstatus.NEW,
            i,
            s,
            o,
      ...
      e.plugins.pluginloader = function (t, n) {
        ...
        e.utils.extend(this, u),
          (this.setupPlugins = function (e, t, n) {
            var i = { length: 0, plugins: {} },
              s = { length: 0, plugins: {} };
            for (var o in r) {
              var u = r[o].getPluginName();
              r[o].getFlashPath() &&
                ((i.plugins[r[o].getFlashPath()] = t.plugins[o]),
                (i.plugins[r[o].getFlashPath()].pluginmode =
                  r[o].getPluginmode()),
                i.length++);
              if (r[o].getJS()) {
                ...
                (a.id = e.id + "_" + u),
                  ...
                  s.length++,
                  typeof s.plugins[u].resize != "undefined" &&
                    (e.onReady(n(s.plugins[u], a, !0)),
    ...
    (function (e) {
      ...
      (e.api = function (t) {
        ...
        function d(t) {
          (a = []),
            e.utils.getOuterHTML(t.container) != l &&
              e.api.destroyPlayer(t.id, l);
        }
        function v(e) {
          return function (t) {
            var n = t.newstate,
            ...
            if (n == e) {
              ...
              if (s)
                for (var o = 0; o < s.length; o++)
                  typeof s[o] == "function" &&
                    s[o].call(this, { oldstate: i, newstate: n });
            }
          };
        }
        function m(e, t) {
        ...
        return (
              ...
              ? e.utils.extend(r, {
                  ...
                  onShow: function (t) {
                    return (
                      n.componentListener(
                        "dock",
                        e.api.events.JWPLAYER_COMPONENT_SHOW,
                        t
                      ),
                      r
                    );
                  ...
                  onHide: function (t) {
                    return (
                      n.componentListener(
                        "dock",
                        e.api.events.JWPLAYER_COMPONENT_HIDE,
                        t
                      ),
                      r
                    );
          ...
          (this.getPlaylistItem = function (t) {
            return (
              e.utils.exists(t) || (t = this.getCurrentItem()),
              this.getPlaylist()[t]
            );
          }),
          ...
          (this.resize = function (e, t) {
            if (this.renderingMode == "html5") o.jwResize(e, t);
            else {
          ...
          (this.play = function (t) {
            return (
              typeof t == "undefined"
                ? ((t = this.getState()),
                  t == e.api.events.state.PLAYING ||
                  t == e.api.events.state.BUFFERING
          ...
          (this.onBufferFull = function (t) {
            return this.eventListener(
              e.api.events.JWPLAYER_MEDIA_BUFFER_FULL,
              t
            );
          }),
          ...
          (this.onBeforePlay = function (t) {
            return this.eventListener(
              e.api.events.JWPLAYER_MEDIA_BEFOREPLAY,
              t
            );
          }),
          (this.onBeforeComplete = function (t) {
            return this.eventListener(
              e.api.events.JWPLAYER_MEDIA_BEFORECOMPLETE,
              t
            );
          }),
          ...
          (this.componentListener = function (e, t, n) {
            return (
              i[e] || (i[e] = {}),
              i[e][t] || ((i[e][t] = []), this.eventListener(t, m(e, t))),
              i[e][t].push(n),
              this
            );
          }),
          ...
          (this.eventListener = function (e, t) {
            return (
              n[e] || ((n[e] = []), o && u && this.addInternalListener(o, e)),
              n[e].push(t),
              this
            );
          }),
          ...
          (this.callInternal = function () {
            if (u) {
              ...
              return typeof o != "undefined" && typeof o[e] == "function"
                ? t.length == 2
                  ? o[e](t[0], t[1])
                  : t.length == 1
                  ? o[e](t[0])
          ...
          (this.playerReady = function (t) {
            ...
            this.eventListener(
              e.api.events.JWPLAYER_PLAYLIST_ITEM,
              function (e) {
                c = {};
              }
            ),
              this.eventListener(
                e.api.events.JWPLAYER_MEDIA_META,
                function (t) {
        ...
        (e.api.selectPlayer = function (t) {
          ...
          e.utils.exists(t) || (t = 0),
            t.nodeType
              ? (n = t)
              : typeof t == "string" && (n = document.getElementById(t));
          if (n) {
        ...
        (e.api.destroyPlayer = function (n, r) {
          ...
          if (i >= 0) {
            ...
            document.getElementById(t[i].id + "_wrapper") &&
              (u = document.getElementById(t[i].id + "_wrapper"));
            if (u)
              if (r) e.utils.setOuterHTML(u, r);
              else {
                var f = document.createElement("div"),
                  l = u.id;
                u.id.indexOf("_wrapper") == u.id.length - 8 &&
                  (newID = u.id.substring(0, u.id.length - 8)),
                  f.setAttribute("id", l),
  ...
  (playerReady = function (e) {
    ...
    (function (e) {
      e.api.instream = function (t, n, r, i) {
        ...
        function v(t, n) {
          return (
            c[t] || ((c[t] = []), d(e.api.events.JWPLAYER_PLAYER_STATE, m(t))),
            c[t].push(n),
            this
          );
        }
            ...
            if (n == e) {
              ...
              if (i)
                for (var s = 0; s < i.length; s++)
                  typeof i[s] == "function" &&
                    i[s].call(this, { oldstate: r, newstate: n, type: t.type });
            }
          };
        }
        var s = t,
    ...
    (function (e) {
      ...
      (e.embed = function (n) {
          ...
          if (o.getStatus() == t.loaderstatus.COMPLETE) {
            for (var r = 0; r < s.modes.length; r++)
              if (s.modes[r].type && e.embed[s.modes[r].type]) {
                ...
                var y = new e.embed[s.modes[r].type](
            ...
            t.log("No suitable players found"),
              new e.embed.logo(
                t.extend({ hide: !0 }, s.components.logo),
                "none",
                n.id
              );
          }
        ...
        return (
          o.addEventListener(e.events.COMPLETE, f),
    ...
    (function (e) {
      function n(e) {
        var n = [
          { type: "flash", src: e ? e : "/jwplayer/player.swf" },
          { type: "html5" },
          { type: "download" },
        ];
      ...
      function s(e) {
        ...
        return (
          (t =
            e instanceof Array ||
            (typeof e == "object" && !e.position && !e.size)),
          t
        );
      }
      function o(e) {
      ...
      var t = e.utils,
        r = { players: "modes", autoplay: "autostart" },
      ...
      (e.embed.deserialize = function (e) {
        ...
        (e.embed.config = function (i, a) {
          var f = t.extend({}, i),
            l;
          s(f.playlist) && ((l = f.playlist), delete f.playlist),
          ...
          for (var m = 0; m < u.length; m++) {
            ...
            t.exists(f[y]) &&
              (typeof f[y] != "object"
                ? (f.components[y] || (f.components[y] = {}),
                  y == "logo"
                    ? (f.components[y].file = f[y])
                    : (f.components[y].position = f[y]),
                  delete f[y])
                : (f.components[y] || (f.components[y] = {}),
                  t.extend(f.components[y], f[y]),
                  delete f[y])),
              typeof f[y + "size"] != "undefined" &&
                (f.components[y] || (f.components[y] = {}),
                (f.components[y].size = f[y + "size"]),
                delete f[y + "size"]);
          }
          typeof f.icons != "undefined" &&
            (f.components.display || (f.components.display = {}),
            (f.components.display.icons = f.icons),
            delete f.icons);
          for (var b in r) f[b] && (f[r[b]] || (f[r[b]] = f[b]), delete f[b]);
          var w;
          return (
            f.flashplayer && !f.modes
              ? ((w = n(f.flashplayer)), delete f.flashplayer)
              : f.modes
              ? (typeof f.modes == "string"
                  ? (w = n(f.modes))
                  : f.modes instanceof Array
                  ? (w = f.modes)
                  : typeof f.modes == "object" &&
                    f.modes.type &&
                    (w = [f.modes]),
                delete f.modes)
              : (w = n()),
      ...
      e.embed.download = function (t, n, r, i, s) {
        ...
        (this.embed = function () {
          ...
          var l,
            ...
            p,
            d = {};
          r.playlist && r.playlist.length
            ? ((d.file = r.playlist[0].file),
              (h = r.playlist[0].image),
              (d.levels = r.playlist[0].levels))
            : ((d.file = r.file), (h = r.image), (d.levels = r.levels)),
            d.file
              ? (l = d.file)
              : d.levels && d.levels.length && (l = d.levels[0].file),
            (p = l ? "pointer" : "auto");
          var v = {
              display: {
                style: {
            ...
            m = function (n, r, i) {
              ...
              return (
                i ? (s.id = i) : (s.id = t.id + "_jwplayer_" + r),
          ...
          (i.display = m("a", "display", t.id)),
            ...
            h &&
              i.display_image.setAttribute("src", e.utils.getAbsolutePath(h)),
          ...
          i.display.appendChild(
            new e.embed.logo(r.components.logo, "download", t.id)
          ),
          ...
          (this.supportsConfig = function () {
            ...
            if (t.levels && t.levels.length)
              for (var n = 0; n < t.levels.length; n++)
                if (
                  t.levels[n].file &&
                  o(t.levels[n].file, t.provider, t.playlistfile)
                )
                  return !0;
          });
      };
      ...
      e.embed.flash = function (t, n, r, i, s) {
        ...
        function l(e, t) {
          if (e[t]) {
            ...
            for (var r in n) {
              var i = n[r];
              if (typeof i == "string") e[r] || (e[r] = i);
              else for (var s in i) e[r + "." + s] || (e[r + "." + s] = i[s]);
            }
            delete e[t];
          }
        }
          ...
          for (var r in t)
            typeof t[r] == "object"
              ? (n +=
                  ...
                  "=" +
                  encodeURIComponent(
                    "[[JSON]]" + e.utils.strings.jsonToString(t[r])
                  ) +
                  "&")
        ...
        (this.embed = function () {
          ...
          var f,
            ...
            d = p.width,
            v = p.height;
          t.id + "_wrapper" == t.parentNode.id
            ? (f = document.getElementById(t.id + "_wrapper"))
            : ((f = document.createElement("div")),
              (f.id = t.id + "_wrapper"),
              e.utils.wrap(t, f),
              e.utils.css(f, { position: "relative", width: d, height: v }));
          ...
          p.wmode && (S = p.wmode),
            l(p, "components"),
            l(p, "providers"),
            typeof p["dock.position"] != "undefined" &&
              p["dock.position"].toString().toLowerCase() == "false" &&
          ...
          (this.supportsConfig = function () {
            if (e.utils.hasFlash()) {
              ...
              var t = e.utils.getFirstPlaylistItemFromConfig(r);
              if (
                typeof t.file == "undefined" &&
                typeof t.levels == "undefined"
              )
                return !0;
              ...
              if (t.levels && t.levels.length)
                for (var n = 0; n < t.levels.length; n++)
                  if (
                    t.levels[n].file &&
                    flashCanPlay(t.levels[n].file, t.provider)
                  )
                    return !0;
            }
            return !1;
          ...
          (flashCanPlay = function (t, n) {
            ...
            return i
              ? e.utils.exists(e.utils.extensionmap[i]) &&
                !e.utils.exists(e.utils.extensionmap[i].flash)
                ? !1
                : !0
              : !0;
          });
    ...
    (function (e) {
      e.embed.html5 = function (t, n, r, i, s) {
        ...
        (this.embed = function () {
          ...
          var n = e.utils.extend({ screencolor: "0x000000" }, r),
            u = ["plugins", "modes", "events"];
          for (var l = 0; l < u.length; l++) delete n[u[l]];
          n.levels && !n.sources && (n.sources = r.levels),
            n.skin &&
              n.skin.toLowerCase().indexOf(".zip") > 0 &&
              (n.skin = n.skin.replace(/\.zip/i, ".xml"));
          ...
          (html5CanPlay = function (t, n, r, i) {
            ...
            return !e.utils.exists(s) ||
              !e.utils.exists(e.utils.extensionmap[s])
              ? !0
              : e.utils.exists(e.utils.extensionmap[s].html5)
              ? e.utils.isLegacyAndroid() && s.match(/m4v|mp4/)
                ? !0
                : browserCanPlay(t, e.utils.extensionmap[s].html5)
              : !1;
          }),
          (browserCanPlay = function (e, t) {
            return t
              ? e.canPlayType(t)
                ? !0
                : t == "audio/mp3" && navigator.userAgent.match(/safari/i)
    ...
    (function (e) {
      e.embed.logo = function (t, n, r) {
        ...
        function c() {
          ...
          if (!o.file) return;
          o.file.indexOf("http://") === 0
            ? (s.src = o.file)
            : (s.src = o.prefix + o.file);
        }
        function h() {
          o.link
            ? ((s.onmouseover = v), (s.onmouseout = d), (s.onclick = p))
            : (this.mouseEnabled = !1);
        }
        function p(e) {
          typeof e != "undefined" && (e.preventDefault(), e.stopPropagation()),
    ...
    (function (e) {
      ...
      (e.html5.view = function (i, s, o) {
        function L() {
          function e() {
            return u.skin.getComponentSettings("display") &&
        ...
        function A() {
          for (var e = 0; e < l.plugins.order.length; e++) {
            ...
            t.exists(l.plugins.object[n].getDisplayElement) &&
              ((l.plugins.object[n].height = t.parseDimension(
                l.plugins.object[n].getDisplayElement().style.height
              )),
              (l.plugins.object[n].width = t.parseDimension(
                l.plugins.object[n].getDisplayElement().style.width
              )),
              (l.plugins.config[n].currentPosition =
                l.plugins.config[n].position));
          }
          _();
        }
        function O(e) {
        ...
        function _(e) {
          ...
          if (t.exists(n)) {
            w != n &&
              (w && w.parentNode && w.parentNode.replaceChild(n, w), (w = n));
            for (var r = 0; r < l.plugins.order.length; r++) {
              var i = l.plugins.order[r];
              t.exists(l.plugins.object[i].getDisplayElement) &&
                (l.plugins.config[i].currentPosition =
                  l.plugins.config[i].position);
            }
          }
          P(l.width, l.height);
        }
        function D(t) {
          switch (t.keyCode) {
            case 27:
              ...
              break;
            case 32:
              u.jwGetState() != e.api.events.state.IDLE &&
              u.jwGetState() != e.api.events.state.PAUSED
                ? u.jwPause()
                : u.jwPlay();
          }
        }
        function P(e, i) {
          ...
          if (S && $())
            try {
              l.fullscreen &&
                !l.getMedia().getDisplayElement().webkitDisplayingFullscreen &&
                (l.fullscreen = !1);
            } catch (o) {}
          if (!l.fullscreen) {
            (p = e),
              ...
              typeof e == "string" && e.indexOf("%") > 0
                ? (p =
                    (t.getElementWidth(t.parentNode(h)) *
                      parseInt(e.replace("%"), "")) /
                    100)
                : (p = e),
              typeof i == "string" && i.indexOf("%") > 0
                ? (v =
                    (t.getElementHeight(t.parentNode(h)) *
                      parseInt(i.replace("%"), "")) /
                    100)
                : (v = i);
            var u = {
            ...
            f &&
              ((a.width = t.parseDimension(f.style.width)),
        ...
        function B(r, i, s) {
          ...
          for (var u = 0; u < i.length; u++) {
            ...
            if (t.exists(l.plugins.object[f].getDisplayElement))
              if (
                l.plugins.config[f].currentPosition !=
                e.html5.view.positions.NONE
              ) {
                var c = r(f, g--);
                if (!c) o.push(f);
                else {
                  var h = c.width,
                    p = c.height;
                  s && (delete c.width, delete c.height),
                    n(l.plugins.object[f].getDisplayElement(), c),
                    l.plugins.object[f].resize(h, p);
                }
              } else
                n(l.plugins.object[f].getDisplayElement(), { display: "none" });
          }
          return o;
        }
        function j(e, n) {
          if (
            ...
            l.plugins.config[e].position &&
            V(l.plugins.config[e].position)
          ) {
            t.exists(l.plugins.object[e].getDisplayElement().parentNode) ||
              h.appendChild(l.plugins.object[e].getDisplayElement());
            var r = R(e);
            return (r.zIndex = n), r;
          }
          return !1;
        ...
        function F(e, n) {
          return (
            t.exists(l.plugins.object[e].getDisplayElement().parentNode) ||
              m.appendChild(l.plugins.object[e].getDisplayElement()),
            {
              position: "absolute",
        ...
        function V(t) {
          return (
            [
              e.html5.view.positions.TOP,
              e.html5.view.positions.RIGHT,
              e.html5.view.positions.BOTTOM,
              e.html5.view.positions.LEFT,
            ]
              .toString()
              .indexOf(t.toUpperCase()) > -1
          );
        }
        function $() {
          return u.jwGetState() != e.api.events.state.IDLE &&
            !E &&
            l.getMedia() &&
            l.getMedia().getDisplayElement() &&
            l.getMedia().getDisplayElement().webkitSupportsFullscreen &&
            t.useNativeFullscreen()
            ? !0
            : !1;
        }
        var u = i,
          ...
          q = (this.resizeMedia = function () {
            ...
            if (i && i.tagName.toLowerCase() == "video") {
              ...
              (i.style.position = "absolute"),
                t.fadeTo(i, 1, 0.25),
                i.parentNode &&
                  ((i.parentNode.style.left = m.style.left),
                  (i.parentNode.style.top = m.style.top));
              if (
                l.fullscreen &&
                u.jwGetStretching() == e.utils.stretching.EXACTFIT &&
                !t.isMobile()
              ) {
                ...
                t.stretch(
                  ...
                  s,
                  t.getElementWidth(m),
                  t.getElementHeight(m),
                  x,
                  T
                ),
                  t.stretch(
                    e.utils.stretching.EXACTFIT,
                    i,
                    t.parseDimension(s.style.width),
                    t.parseDimension(s.style.height),
                    i.videoWidth ? i.videoWidth : 400,
                    i.videoHeight ? i.videoHeight : 300
                  ),
                  n(i, { left: s.style.left, top: s.style.top });
              } else
                r ||
                  t.stretch(
                    u.jwGetStretching(),
              ...
              o
                ? l
                    .getMedia()
                    .resize(
                      t.parseDimension(o.style.width),
                      t.parseDimension(o.style.height)
                    )
                : l
                    .getMedia()
                    .resize(
                      t.parseDimension(m.style.width),
                      t.parseDimension(m.style.height)
                    );
            }
          }),
            ...
            switch (i.toUpperCase()) {
              case e.html5.view.positions.TOP:
                (r.top = t.parseDimension(m.style.top)),
                  ...
                  (r.width =
                    t.getElementWidth(m) -
                    t.parseDimension(m.style.left) -
                    t.parseDimension(m.style.right)),
                  (r.height = l.plugins.object[n].height),
                  (m.style[i] =
                    t.parseDimension(m.style[i]) +
              ...
              case e.html5.view.positions.RIGHT:
                (r.top = t.parseDimension(m.style.top)),
                  ...
                  (r.height =
                    t.getElementHeight(m) -
                    t.parseDimension(m.style.top) -
                    t.parseDimension(m.style.bottom)),
        ...
        var U,
          ...
          X = (this.fullscreen = function (e) {
            ...
            var o = {
              ...
              u = { position: "relative", height: z, width: W, zIndex: 0 };
            if ($() && i && i.webkitSupportsFullscreen) {
              ...
              if (e) {
                ...
                (l.width = Math.abs(f.left) + Math.abs(f.right)),
                  ...
                  l.getMedia() &&
                    l.getMedia().getDisplayElement() &&
                    n(l.getMedia().getDisplayElement(), o),
                  (o.zIndex = 2),
                  n(m, o),
                  (E = !0);
              } else
        ...
        this.setupInstream = function (e, n) {
          t.css(_instreamArea, { display: "block", position: "absolute" }),
            (m.style.display = "none"),
      ...
      (_utils = e.utils),
        ...
        (e.html5.controlbar = function (n, r) {
          function M() {
            return (
              x ||
                ((x = i.skin.getSkinElement("controlbar", "background")),
                x || (x = { width: 0, height: 0, src: null })),
              x
            );
          }
          function _() {
          ...
          function D() {
            ...
            for (var t in e) {
              var n = e[t];
              typeof y[n] != "undefined" &&
                (E[n] = _utils.getBoundingClientRect(y[n]));
            }
          }
          function H(t) {
            if (T) return;
            clearTimeout(N);
            if (
              s.position == e.html5.view.positions.OVER ||
              i.jwGetFullscreen()
            )
              switch (i.jwGetState()) {
          ...
          function B() {
            T ||
              (q(),
              o.style.opacity == 1 &&
                (_utils.cancelAnimation(o), _utils.fadeTo(o, 0, 0.1, 1, 0)));
          }
          function j() {
            T ||
              (I(),
              o.style.opacity == 0 &&
                (_utils.cancelAnimation(o), _utils.fadeTo(o, 1, 0.1, 0, 0)));
          }
          function F(e) {
            return function () {
              k &&
                C != e &&
                ((C = e),
                O.sendEvent(e, { component: "controlbar", boundingRect: R() }));
            };
          }
          function R() {
            return s.position == e.html5.view.positions.OVER ||
              i.jwGetFullscreen()
              ? _utils.getDimensions(o)
          ...
          function U(e, t, n, r) {
            ...
            return (
              w
                ? (i = document.getElementById(o.id + "_" + e))
                : (r || (r = "div"),
          ...
          function z() {
            if (i.jwGetHeight() <= 40) {
              ...
              for (var e = 0; e < s.layout.left.elements.length; e++)
                s.layout.left.elements[e].name == "fullscreen" &&
                  s.layout.left.elements.splice(e, 1);
              for (e = 0; e < s.layout.right.elements.length; e++)
                s.layout.right.elements[e].name == "fullscreen" &&
                  s.layout.right.elements.splice(e, 1);
              ot();
            }
            ...
            switch (e.name) {
              ...
              case "elapsed":
                $(
                  ...
                  null,
                  null,
                  i.skin.getSkinElement("controlbar", "elapsedBackground")
                );
                break;
              case "time":
                (s = _utils.exists(
                  i.skin.getSkinElement("controlbar", "timeSliderCapLeft")
                )
                  ? i.skin.getSkinElement("controlbar", "timeSliderCapLeft")
                      .width
                  : 0),
                  (o = _utils.exists(
                    i.skin.getSkinElement("controlbar", "timeSliderCapRight")
                  )
                    ? i.skin.getSkinElement("controlbar", "timeSliderCapRight")
                        .width
                    : 0),
              ...
              case "volume":
                (s = _utils.exists(
                  i.skin.getSkinElement("controlbar", "volumeSliderCapLeft")
                )
                  ? i.skin.getSkinElement("controlbar", "volumeSliderCapLeft")
                      .width
                  : 0),
                  (o = _utils.exists(
                    i.skin.getSkinElement("controlbar", "volumeSliderCapRight")
                  )
                  ...
                  (r = t == "left" ? s : o),
                  (u =
                    i.skin.getSkinElement("controlbar", "volumeSliderRail")
                      .width +
                    s +
                    o),
                  (a = {
              ...
              case "duration":
                $(
                  ...
                  null,
                  null,
                  i.skin.getSkinElement("controlbar", "durationBackground")
                );
            }
          }
          function $(e, t, n, r, o, u, a) {
            if (
              _utils.exists(i.skin.getSkinElement("controlbar", e)) ||
              e.indexOf("Text") > 0 ||
              e.indexOf("divider") === 0
            ) {
              var c = {
              ...
              (e.indexOf("next") === 0 || e.indexOf("prev") === 0) &&
                (i.jwGetPlaylist().length < 2 ||
                  s.hideplaylistcontrols.toString() == "true") &&
                s.forcenextprev.toString() != "true" &&
                ((n = !1), (c.display = "none"));
              var h;
              if (e.indexOf("Text") > 0)
                (e.innerhtml = "00:00"),
                  (c.font =
                    s.fontsize + "px/" + (M().height + 1) + "px " + s.font),
                  (c.color = s.fontcolor),
                  (c.textAlign = "center"),
                  ...
                  (c.cursor = "default"),
                  a &&
                    ((c.background = "url(" + a.src + ") no-repeat center"),
                    (c.backgroundSize = "100% " + M().height + "px")),
                  (c.padding = "0 5px");
              else if (e.indexOf("divider") === 0)
                if (u) isNaN(parseInt(u)) || (h = parseInt(u));
                else if (a) {
                  var p = i.skin.getSkinElement("controlbar", a);
                  p &&
                    ((c.background = "url(" + p.src + ") repeat-x center left"),
                    (h = p.width));
                } else
                  (c.background =
                    "url(" +
                    i.skin.getSkinElement("controlbar", "divider").src +
                    ") repeat-x center left"),
                    (h = i.skin.getSkinElement("controlbar", "divider").width);
              else
                (c.background =
                  "url(" +
                  i.skin.getSkinElement("controlbar", e).src +
                  ") repeat-x center left"),
              ...
              if (w) _css(y[e], c);
                ...
                var d = U(e, r, c);
                _utils.exists(
                  i.skin.getSkinElement("controlbar", e + "Over")
                ) &&
                  ((d.onmouseover = function (t) {
                    d.style.backgroundImage = [
                      "url(",
                      i.skin.getSkinElement("controlbar", e + "Over").src,
                      ")",
                    ].join("");
                  }),
          ...
          function K() {
            s.hideplaylistcontrols ||
              (i.jwGetPlaylist().length > 1 ||
              s.forcenextprev.toString() == "true"
                ? (_show(y.nextButton), _show(y.prevButton))
                : (_hide(y.nextButton), _hide(y.prevButton)),
              at(),
              G());
          }
          function Q(e) {
            (d = i.jwGetPlaylist()[e.index].duration),
              (S = -1),
              st({ id: i.id, duration: d, position: 0 }),
              tt({ id: i.id, bufferProgress: 0 });
          }
          function G() {
            st({ id: i.id, duration: i.jwGetDuration(), position: 0 }),
              tt({ id: i.id, bufferProgress: 0 }),
              nt({ id: i.id, mute: i.jwGetMute() }),
              rt({ id: i.id, newstate: e.api.events.state.IDLE }),
              ft({ id: i.id, volume: i.jwGetVolume() });
          }
          function Y(e, t, n) {
            if (w) return;
          ...
          function Z(e) {
            if (w) return;
            var t = y[e + "Slider"];
            _css(y.elements, { cursor: "pointer" }),
              _css(t, { cursor: "pointer" }),
          ...
          function et(t) {
            ...
            if (c == "time") {
              ...
              r < 0 ? (r = 0) : r > d && (r = d - 3),
                (i.jwGetState() == e.api.events.state.PAUSED ||
                  i.jwGetState() == e.api.events.state.IDLE) &&
                  i.jwPlay(),
                i.jwSeek(r);
            } else if (c == "volume") {
          ...
          function nt(e) {
            e.mute
              ? (_hide(y.muteButton),
                ...
                _hide(y.volumeSliderProgress))
              : (_show(y.muteButton),
                _hide(y.unmuteButton),
                _show(y.volumeSliderProgress));
          }
          function rt(t) {
            t.newstate == e.api.events.state.BUFFERING ||
            t.newstate == e.api.events.state.PLAYING
              ? (_show(y.pauseButton), _hide(y.playButton))
              : (_hide(y.pauseButton), _show(y.playButton)),
              H(),
              t.newstate == e.api.events.state.IDLE
                ? (_hide(y.timeSliderBuffer),
                  _hide(y.timeSliderProgress),
                  _hide(y.timeSliderThumb),
                  st({ id: i.id, duration: i.jwGetDuration(), position: 0 }))
                : (_show(y.timeSliderBuffer),
                  t.newstate != e.api.events.state.BUFFERING &&
                    (_show(y.timeSliderProgress), _show(y.timeSliderThumb)));
          }
          function it(e) {
            tt({ bufferPercent: 0 }),
              st(_utils.extend(e, { position: 0, duration: d }));
          }
          function st(e) {
            _utils.exists(e.position) && (p = e.position);
            var t = !1;
            _utils.exists(e.duration) &&
              e.duration != d &&
              ((d = e.duration), (t = !0));
            var n = (p === d) === 0 ? 0 : p / d,
              r = E.timeSliderRail;
            if (r) {
              var s = isNaN(Math.round(r.width * n))
                  ? 0
                  : Math.round(r.width * n),
          ...
          function ot() {
            ...
            for (var r = 0; r < e.length; r++) {
              ...
              for (var s in i) {
                ...
                i[s].id.indexOf(o.id + "_divider") === 0 &&
                n &&
                n.id.indexOf(o.id + "_divider") === 0 &&
                i[s].style.backgroundImage == n.style.backgroundImage
          ...
          function ut() {
            i.jwGetFullscreen()
              ? (_show(y.normalscreenButton), _hide(y.fullscreenButton))
              : (_hide(y.normalscreenButton), _show(y.fullscreenButton)),
              i.jwGetState() == e.api.events.state.BUFFERING ||
              i.jwGetState() == e.api.events.state.PLAYING
                ? (_show(y.pauseButton), _hide(y.playButton))
                : (_hide(y.pauseButton), _show(y.playButton)),
              i.jwGetMute() == 1
                ? (_hide(y.muteButton),
          ...
          function at() {
            ot(), ut();
            var t = { width: m },
              n = { float: "left", styleFloat: "left", cssFloat: "left" };
            if (
              s.position == e.html5.view.positions.OVER ||
              i.jwGetFullscreen()
            )
            ...
            if (_utils.exists(y.volumeSliderRail)) {
              ...
              if (y.volumeSliderThumb) {
                var u =
                  r -
                  Math.round(
                    _utils.parseDimension(y.volumeSliderThumb.style.width) / 2
                  );
                (u = Math.min(
                  Math.max(u, 0),
                  n - _utils.parseDimension(y.volumeSliderThumb.style.width)
                )),
                  _css(y.volumeSliderThumb, { left: u });
              }
              _utils.exists(y.volumeSliderCapLeft) &&
                _css(y.volumeSliderCapLeft, { left: 0 });
            }
          }
          function lt() {
            try {
              var e =
                i.id.indexOf("_instream") > 0
                  ? i.id.replace("_instream", "")
                  : i.id;
          ...
          function ct() {
            _(),
              ...
              s.position == e.html5.view.positions.OVER && s.idlehide
                ? ((o.style.opacity = 0), (k = !0))
                : ((o.style.opacity = 1),
                  setTimeout(function () {
                    (k = !0), I();
                  }, 1)),
          ...
          var i = n,
            s = _utils.extend(
              {},
              t,
              i.skin.getComponentSettings("controlbar"),
              r
            );
          if (
            s.position == e.html5.view.positions.NONE ||
            typeof e.html5.view.positions[s.position] == "undefined"
          )
            return;
          _utils.mapLength(i.skin.getComponentLayout("controlbar")) > 0 &&
            (s.layout = i.skin.getComponentLayout("controlbar"));
          var o,
            u,
            f,
            l,
          ...
          _utils.extend(this, O),
            ...
            (this.resize = function (e, t) {
              lt(),
                ...
                (g = t),
                L != i.jwGetFullscreen() &&
                  ((L = i.jwGetFullscreen()), L || H(), (C = undefined));
              var n = at();
              return (
                st({ id: i.id, duration: d, position: p }),
                tt({ id: i.id, bufferPercent: v }),
                n
              );
            }),
            (this.show = function () {
          ...
          var P,
            I = F(e.api.events.JWPLAYER_COMPONENT_SHOW),
            q = F(e.api.events.JWPLAYER_COMPONENT_HIDE);
          return ct(), this;
        });
    })(jwplayer),
    (function (e) {
      ...
      e.html5.controller = function (t, r, s, o) {
        ...
        function x(t) {
          if (!y) {
            (y = !0),
              ...
              e.utils.exists(window[s.config.playerReady]) &&
                window[s.config.playerReady](t);
            while (g.length > 0) {
              var n = g.shift();
        ...
        function T() {
          try {
            ...
            return (
              _(a.item),
              a.playlist[a.item].levels[0].file.length > 0 &&
                (h || a.state == e.api.events.state.IDLE
                  ? (a.getMedia().load(a.playlist[a.item]), (h = !1))
                  : a.state == e.api.events.state.PAUSED &&
                    a.getMedia().play()),
              !0
            );
          } catch (t) {
        ...
        function k(t) {
          ...
          try {
            return (
              (a.state != e.api.events.state.IDLE || t) &&
                a.getMedia() &&
                a.getMedia().stop(t),
              d && (v = !0),
              !0
        ...
        function M(t) {
          ...
          try {
            if (a.playlist[t].levels[0].file.length > 0) {
              var n = a.state;
              n !== e.api.events.state.IDLE &&
                (a.playlist[a.item] &&
                a.playlist[a.item].provider == a.playlist[t].provider
                  ? k(!1)
                  : k()),
                _(t),
                T();
        ...
        function _(t) {
          ...
          a.setActiveMediaProvider(a.playlist[t]),
            a.item != t &&
              ((a.item = t),
              (h = !0),
              E.sendEvent(e.api.events.JWPLAYER_PLAYLIST_ITEM, { index: t }));
        }
        function D(t) {
          try {
            _(a.item);
        ...
        function P(t) {
          try {
            ...
            return (
              typeof t == "undefined"
                ? (n.mute(!a.mute), a.setMute(!a.mute))
                : t.toString().toLowerCase() == "true"
                ? (n.mute(!0), a.setMute(!0))
                : (n.mute(!1), a.setMute(!1)),
              !0
            );
          } catch (r) {
            E.sendEvent(e.api.events.JWPLAYER_ERROR, r);
        ...
        function B(t, n) {
          try {
            return (
              typeof t == "undefined" && (t = !a.fullscreen),
              typeof n == "undefined" && (n = !0),
              t != a.fullscreen &&
                ((a.fullscreen = t.toString().toLowerCase() == "true"),
                f.fullscreen(a.fullscreen),
                n &&
                  E.sendEvent(e.api.events.JWPLAYER_FULLSCREEN, {
        ...
        function j(t) {
          try {
            return (
              ...
              d && (v = !1),
              a.loadPlaylist(t),
              a.playlist[a.item].provider
                ? (_(a.item),
                  a.config.autostart.toString().toLowerCase() == "true" &&
                    !n.isIOS() &&
                    !d &&
                    T(),
                  !0)
        ...
        function U() {
          ...
          switch (a.config.repeat.toUpperCase()) {
            ...
            case e.html5.controller.repeatoptions.LIST:
              a.item == a.playlist.length - 1 && !a.config.shuffle
                ? (k(), _(0))
                : L();
              break;
            default:
        ...
        var u = t,
          ...
          y = !1,
          w =
            n.exists(a.config.debug) &&
            a.config.debug.toString().toLowerCase() == "console",
          E = new e.html5.eventdispatcher(l.id, w);
        n.extend(this, E),
          ...
          a.addEventListener(e.api.events.JWPLAYER_MEDIA_TIME, function (e) {
            e.position >= a.playlist[a.item].start &&
              p >= 0 &&
              ((a.playlist[a.item].start = p), (p = -1));
          }),
          a.addEventListener(
            e.api.events.JWPLAYER_MEDIA_COMPLETE,
            function (e) {
              setTimeout(U, 25);
            }
          ),
        ...
        (e.html5.display = function (t, n) {
          ...
          function _(t) {
            (l = o.display_image.naturalWidth),
              ...
              D();
            if (
              s.jwGetState() == e.api.events.state.IDLE ||
              s.jwGetPlaylist()[s.jwGetPlaylistIndex()].provider == "sound"
            )
              _css(o.display_image, { display: "block", opacity: 0 }),
                _utils.fadeTo(o.display_image, 1, 0.1);
            E = !1;
          }
          function D() {
            if (
              s.jwGetFullscreen() &&
              s.jwGetStretching() == e.utils.stretching.EXACTFIT
            ) {
              ...
              _utils.stretch(e.utils.stretching.UNIFORM, t, u, f, k, L),
                _utils.stretch(
                  e.utils.stretching.EXACTFIT,
                  o.display_image,
                  _utils.parseDimension(t.style.width),
                  _utils.parseDimension(t.style.height),
                  l,
                  c
                ),
                _css(o.display_image, { left: t.style.left, top: t.style.top });
            } else
          ...
          function B(t) {
            typeof t.preventDefault != "undefined"
              ? t.preventDefault()
              : (t.returnValue = !1);
            ...
            s.jwGetState() != e.api.events.state.PLAYING
              ? s.jwPlay()
              : s.jwPause();
          }
          function j(e) {
            ...
            (o.display_icon.style.backgroundImage = [
              "url(",
              s.skin.getSkinElement("display", e).src,
              ")",
            ].join("")),
              _css(o.display_icon, {
                ...
                top:
                  (s.skin.getSkinElement("display", "background").height -
                    s.skin.getSkinElement("display", e).height) /
                  2,
                left:
                  (s.skin.getSkinElement("display", "background").width -
                    s.skin.getSkinElement("display", e).width) /
                  2,
              }),
              I(),
              _utils.exists(s.skin.getSkinElement("display", e + "Over"))
                ? ((o.display_icon.onmouseover = function (t) {
                    o.display_icon.style.backgroundImage = [
                      "url(",
                      s.skin.getSkinElement("display", e + "Over").src,
                      ")",
                    ].join("");
                  }),
          ...
          function F() {
            i.icons.toString() == "true" &&
              (_hide(o.display_icon), _hide(o.display_iconBackground), K());
          }
          function I() {
            !T &&
              i.icons.toString() == "true" &&
              (_show(o.display_icon), _show(o.display_iconBackground), J());
          }
          function q(e) {
            (d = !0),
              F(),
              ...
              (o.display_text.style.top =
                (f - _utils.getBoundingClientRect(o.display_text).height) / 2 +
                "px");
          }
          function R() {
          ...
          function z(t) {
            (t.type == e.api.events.JWPLAYER_PLAYER_STATE ||
              t.type == e.api.events.JWPLAYER_PLAYLIST_ITEM) &&
              d &&
              ((d = !1), _hide(o.display_text));
            var n = s.jwGetState();
            if (n == y) return;
            (y = n),
              g >= 0 && clearTimeout(g),
              b ||
              s.jwGetState() == e.api.events.state.PLAYING ||
              s.jwGetState() == e.api.events.state.PAUSED
                ? X(s.jwGetState())
                : (g = setTimeout(W(s.jwGetState()), 500));
          }
          function W(e) {
            return function () {
              X(e);
          ...
          function X(t) {
            ...
            switch (t) {
              case e.api.events.state.BUFFERING:
                _utils.isIPod()
                  ? (R(), F())
                  : (s.jwGetPlaylist()[s.jwGetPlaylistIndex()].provider ==
                      "sound" && V(),
                    (h = 0),
              ...
              case e.api.events.state.IDLE:
                ...
                s.jwGetPlaylist()[s.jwGetPlaylistIndex()].image
                  ? V()
                  : R(),
                  j("playIcon"),
                  (b = !0);
            ...
            if (s.jwGetPlaylist()[s.jwGetPlaylistIndex()]) {
              ...
              e &&
                (e != x
                  ? ((x = e),
                    (E = !0),
                    (o.display_image.src = _utils.getAbsolutePath(e)))
                  : !E &&
                    !S &&
                    ((S = !0),
          ...
          var r = { icons: !0, showmute: !1 },
            ...
            d,
            v = _utils.exists(
              s.skin.getComponentSettings("display").bufferrotation
            )
              ? parseInt(
                  s.skin.getComponentSettings("display").bufferrotation,
                  10
              ...
              : 15,
            m = _utils.exists(
              s.skin.getComponentSettings("display").bufferinterval
            )
              ? parseInt(
                  s.skin.getComponentSettings("display").bufferinterval,
                  10
          ...
          var O = {
            ...
            display_icon: {
              style: {
                ...
                top:
                  (s.skin.getSkinElement("display", "background").height -
                    s.skin.getSkinElement("display", "playIcon").height) /
                  2,
                left:
                  (s.skin.getSkinElement("display", "background").width -
                    s.skin.getSkinElement("display", "playIcon").width) /
                  2,
                border: 0,
                margin: 0,
                padding: 0,
            ...
            display_iconBackground: {
              style: {
                ...
                position: "absolute",
                top:
                  (f - s.skin.getSkinElement("display", "background").height) /
                  2,
                left:
                  (u - s.skin.getSkinElement("display", "background").width) /
                  2,
                border: 0,
                backgroundImage: [
                  "url(",
                  s.skin.getSkinElement("display", "background").src,
                  ")",
                ].join(""),
          ...
          s.jwAddEventListener(e.api.events.JWPLAYER_PLAYER_STATE, z),
            ...
            (this.resize = function (e, t) {
              ...
              _css(o.display, { width: e, height: t }),
                _css(o.display_text, {
                  width: e - 10,
                  top:
                    (t - _utils.getBoundingClientRect(o.display_text).height) /
                    2,
                }),
                _css(o.display_iconBackground, {
                  top:
                    ...
                    2,
                  left:
                    (e - s.skin.getSkinElement("display", "background").width) /
                    2,
                });
          ...
          return (
            (this.setAlternateClickHandler = function (e) {
              C = e;
            }),
      ...
      e.html5.dock = function (r, i) {
        ...
        function T(n, i) {
          ...
          if (f.length > 0) {
            var s = 10,
              p = s,
              g = -1,
              y = r.skin.getSkinElement("dock", "button").height,
              b = r.skin.getSkinElement("dock", "button").width,
              w = n - b - s,
              E,
              S;
            ...
            for (var x = 0; x < f.length; x++) {
              ...
              p + y + s > (T + 1) * i &&
                ((p = (T + 1) * i + s), (T = Math.floor(p / i)));
              var N = u[f[x]].div;
              (N.style.top = (p % i) + "px"),
                (N.style.left =
                  w +
                  (r.skin.getSkinElement("dock", "button").width + s) * T * g +
                  "px");
              var C = {
        ...
        function N(e) {
          return function () {
            !p &&
              m != e &&
              f.length > 0 &&
              ((m = e), w.sendEvent(e, { component: "dock", boundingRect: v }));
          };
        }
        function C(n) {
          t.isMobile()
            ? n.newstate == e.api.events.state.IDLE
              ? O()
              : M()
            : k();
        }
        ...
        function _() {
          p ||
            (A(),
            E.style.opacity == 1 &&
              (t.cancelAnimation(E), t.fadeTo(E, 0, 0.1, 1, 0)));
        }
        function D() {
          p ||
            (L(),
            E.style.opacity == 0 &&
              (t.cancelAnimation(E), t.fadeTo(E, 1, 0.1, 0, 0)));
        }
        function P() {
          try {
        ...
        (E.id = r.id + "_jwplayer_dock"),
          ...
          (this.setButton = function (n, i, s, o) {
            !i && u[n]
              ? (t.arrays.remove(f, n), E.removeChild(u[n].div), delete u[n])
              : i &&
                (u[n] || (u[n] = {}),
                (u[n].handler = i),
                (u[n].outGraphic = s),
                ...
                u[n].div ||
                  ...
                  r.skin.getSkinElement("dock", "button") &&
                    (u[n].div.childNodes[1].src = r.skin.getSkinElement(
                      "dock",
                      "button"
                    ).src),
                  ...
                  (u[n].div.onmouseover = function () {
                    u[n].overGraphic &&
                      (u[n].div.childNodes[0].style.background = S(
                        u[n].overGraphic
                      )),
                      r.skin.getSkinElement("dock", "buttonOver") &&
                        (u[n].div.childNodes[1].src = r.skin.getSkinElement(
                          "dock",
                          "buttonOver"
                        ).src);
      ...
      e.html5.eventdispatcher = function (t, n) {
        ...
        e.utils.extend(this, r),
          (this.sendEvent = function (n, i) {
            e.utils.exists(i) || (i = {}),
              e.utils.extend(i, { id: t, version: e.version, type: n }),
              r.sendEvent(n, i);
          });
      };
    })(jwplayer),
    (function (e) {
      ...
      e.html5.instream = function (n, r, i, s) {
        function L() {
          (_fakemodel = new e.html5.model(
            this,
            c.getMedia() ? c.getMedia().getDisplayElement() : c.container,
            c
          )),
        ...
        function B() {
          ...
          if (S) {
            ...
            S.resize(t.parseDimension(e.width), t.parseDimension(e.height)),
              _css(
                S.getDisplayElement(),
                t.extend({}, n, { zIndex: 1001, opacity: 1 })
              );
          }
          x &&
            (x.resize(t.parseDimension(e.width), t.parseDimension(e.height)),
            _css(x.getDisplayElement(), t.extend({}, e, { zIndex: 1e3 }))),
            h && h.resizeMedia();
        }
        var o = {
        ...
        return (
          (this.load = function (n, r) {
            A(),
              ...
              (w = c.playlist[c.item]),
              (y = l.jwGetState()),
              (y == e.api.events.state.BUFFERING ||
                y == e.api.events.state.PLAYING) &&
                d.pause(),
              (v = d.src ? d.src : d.currentSrc),
              (m = d.innerHTML),
              (g = d.currentTime),
              (x = new e.html5.display(
                k,
                t.extend({}, c.plugins.config.display)
              )),
              x.setAlternateClickHandler(function (t) {
                _fakemodel.state == e.api.events.state.PAUSED
                  ? k.jwInstreamPlay()
                  : H(e.api.events.JWPLAYER_INSTREAM_CLICK, t);
              }),
              C.appendChild(x.getDisplayElement());
            if (!t.isMobile()) {
              S = new e.html5.controlbar(
                k,
                t.extend({}, c.plugins.config.controlbar, {})
              );
              if (
                c.plugins.config.controlbar.position ==
                e.html5.view.positions.OVER
              )
                C.appendChild(S.getDisplayElement());
              else {
                var i =
                  c.plugins.object.controlbar.getDisplayElement().parentNode;
          ...
          (this.jwInstreamDestroy = function (t) {
            ...
            if (S)
              try {
                S.getDisplayElement().parentNode.removeChild(
                  S.getDisplayElement()
                );
              } catch (n) {}
            H(
              e.api.events.JWPLAYER_INSTREAM_DESTROYED,
            ...
            if (
              ...
              d.play(), c.playlist[c.item] == w && c.getMedia().seek(g);
            return;
          }),
          ...
          (this.jwPlay = function (e) {
            f.controlbarpausable.toString().toLowerCase() == "true" &&
              this.jwInstreamPlay();
          }),
          ...
          (this.jwStop = function () {
            f.controlbarstoppable.toString().toLowerCase() == "true" &&
              (this.jwInstreamDestroy(), l.jwStop());
          }),
      ...
      (_css = e.utils.css),
        (e.html5.logo = function (n, r) {
          ...
          function c() {
            ...
            r.position == e.html5.view.positions.OVER &&
              (r.position = t.position);
            try {
              window.location.href.indexOf("https") == 0 &&
                (t.prefix = t.prefix.replace(
          ...
          function h() {
            ...
            o.file.indexOf("/") >= 0
              ? (u.src = o.file)
              : (u.src = o.prefix + o.file);
          }
          function p() {
            o.link
              ? ((u.onmouseover = m), (u.onmouseout = v), (u.onclick = d))
              : (this.mouseEnabled = !1);
          }
          function d(e) {
          ...
          function y() {
            o.hide.toString() == "true" &&
              ((u.style.display = "block"),
              (u.style.opacity = 0),
              e.utils.fadeTo(u, o.out, 0.1, parseFloat(u.style.opacity)),
          ...
          function w() {
            (f = !1),
              o.hide.toString() == "true" &&
                e.utils.fadeTo(u, 0, 0.1, parseFloat(u.style.opacity));
          }
          function E(t) {
            t.newstate == e.api.events.state.BUFFERING &&
              (clearTimeout(s), y());
      ...
      e.html5.mediavideo = function (u, l) {
        ...
        function P() {
          (E = e.api.events.state.IDLE),
            ...
            y.parentNode && ((w.id = y.id), y.parentNode.replaceChild(w, y));
        }
        function H() {
          var e = o[m.id];
          e ||
            (y.tagName.toLowerCase() == "video"
              ? (e = y)
        ...
        function F(t) {
          ...
          Z(e.api.events.JWPLAYER_MEDIA_VOLUME, { volume: n }, !0),
            Z(e.api.events.JWPLAYER_MEDIA_MUTE, { mute: w.muted }, !0);
        }
        function I(t) {
          if (!k) return;
          var r;
          ...
          n.useNativeFullscreen() &&
            n.exists(w.webkitDisplayingFullscreen) &&
            m.fullscreen != w.webkitDisplayingFullscreen &&
            Z(
              e.api.events.JWPLAYER_FULLSCREEN,
              { fullscreen: w.webkitDisplayingFullscreen },
              !0
            ),
            O === !1 &&
              E == e.api.events.state.BUFFERING &&
              (Z(e.api.events.JWPLAYER_MEDIA_BUFFER_FULL), (O = !0)),
            A ||
              (r == 100 && (A = !0),
              n.exists(r) &&
                r > m.buffer &&
                ((m.buffer = Math.round(r)),
        ...
        function q(t) {
          ...
          if (n.exists(t) && n.exists(t.target)) {
            L > 0 &&
              !isNaN(t.target.duration) &&
              (isNaN(m.duration) || m.duration < 1) &&
              (t.target.duration == Infinity
                ? (m.duration = 0)
                : (m.duration = Math.round(t.target.duration * 10) / 10)),
            ...
            if (E == e.api.events.state.PLAYING) {
              ...
              (m.position =
                m.duration > 0
                  ? Math.round(t.target.currentTime * 10) / 10
                  : 0),
        ...
        function z(t) {
          ...
          var n = Math.round(w.duration * 10) / 10,
            r = { height: w.videoHeight, width: w.videoWidth, duration: n };
          L ||
            ((m.duration < n || isNaN(m.duration)) &&
              w.duration != Infinity &&
              (m.duration = n)),
            Z(e.api.events.JWPLAYER_MEDIA_META, { metadata: r });
        }
        function W(t) {
          if (!k) return;
          ...
          if (
            (t.target.error && t.target.tagName.toLowerCase() == "video") ||
            (t.target.parentNode.error &&
              t.target.parentNode.tagName.toLowerCase() == "video")
          ) {
            var i = n.exists(t.target.error)
              ? t.target.error
              : t.target.parentNode.error;
            switch (i.code) {
          ...
          _(!1),
            (r += X()),
            (_error = !0),
            Z(e.api.events.JWPLAYER_ERROR, { message: r });
          return;
        }
        function X() {
          var t = "";
        ...
        function K(t) {
          n.exists(w.webkitDisplayingFullscreen) &&
            m.fullscreen &&
            !w.webkitDisplayingFullscreen &&
            Z(e.api.events.JWPLAYER_FULLSCREEN, { fullscreen: !1 }, !0);
        }
        function Q(e) {
          if (
            e.length > 0 &&
            n.userAgentMatch(/Safari/i) &&
            !n.userAgentMatch(/Chrome/i)
          ) {
            var t = -1;
            for (var r = 0; r < e.length; r++)
        ...
        P(),
          (this.load = function (t, o) {
            ...
            if (t.levels && t.levels.length > 0)
              if (t.levels.length == 1 || n.isIOS()) w.src = t.levels[0].file;
              else {
            ...
            (w.volume = m.volume / 100),
              ...
              o &&
                ...
                Z(e.api.events.JWPLAYER_MEDIA_BUFFER, { bufferPercent: 0 }),
                V()),
          ...
          (this.play = function () {
            ...
            V(),
              O
                ? B(e.api.events.state.PLAYING)
                : (w.load(), B(e.api.events.state.BUFFERING)),
              w.play();
          }),
          (this.pause = function () {
            if (!k) return;
          ...
          (this.seek = function (e) {
            ...
            !S && w.readyState > 0
              ? !(m.duration <= 0 || isNaN(m.duration)) &&
                !(m.position <= 0 || isNaN(m.position)) &&
                ((w.currentTime = e), w.play())
              : (N = e);
          });
        ...
        (this.fullscreen = function (e) {
          e === !0
            ? this.resize("100%", "100%")
            : this.resize(m.config.width, m.config.height);
        }),
          (this.resize = function (e, t) {}),
          (this.volume = function (t) {
            r ||
              ((w.volume = t / 100),
              Z(e.api.events.JWPLAYER_MEDIA_VOLUME, { volume: t / 100 }));
          }),
          (this.mute = function (t) {
            r ||
              ((w.muted = t), Z(e.api.events.JWPLAYER_MEDIA_MUTE, { mute: t }));
          }),
          (this.getDisplayElement = function () {
            return w;
          }),
      ...
      e.html5.mediayoutube = function (t, r) {
        ...
        function p(e) {
          ...
          return (
            n == "" &&
              (e.indexOf("/v/") >= 0
                ? (n = e.substr(e.indexOf("/v/") + 3))
                : e.indexOf("youtu.be") >= 0
                ? (n = e.substr(e.indexOf("youtu.be/") + 9))
                : (n = e)),
        ...
        var s = t,
          o = document.getElementById(r.id),
          u = e.api.events.state.IDLE,
          f,
          l;
        return (
          (this.getDisplayElement = this.detachMedia =
            function () {
              return o;
            }),
          (this.attachMedia = function () {}),
          (this.play = function () {
            u == e.api.events.state.IDLE
              ? (i.sendEvent(e.api.events.JWPLAYER_MEDIA_BUFFER, {
                ...
                c(e.api.events.state.PLAYING))
              : u == e.api.events.state.PAUSED && c(e.api.events.state.PLAYING);
          }),
          (this.pause = function () {
          ...
          (this.mute = function (t) {
            (o.muted = t),
              i.sendEvent(e.api.events.JWPLAYER_MEDIA_MUTE, { mute: t });
          }),
          (this.resize = function (e, t) {
            e * t > 0 &&
              f &&
              ((f.width = l.width = e), (f.height = l.height = t));
          }),
          (this.fullscreen = function (e) {
            e === !0
              ? this.resize("100%", "100%")
              : this.resize(s.config.width, s.config.height);
          }),
    ...
    (function (jwplayer) {
      ...
      jwplayer.html5.model = function (api, container, options) {
        ...
        function _loadComplete() {
          _model.config.shuffle
            ? (_model.item = _getShuffleItem())
            : (_model.config.item >= _model.playlist.length
                ? (_model.config.item = _model.playlist.length - 1)
                : _model.config.item < 0 && (_model.config.item = 0),
        ...
        var _api = api,
          ...
          _model = {
            ...
            config: {
              ...
              mute:
                _cookies.mute &&
                _cookies.mute.toString().toLowerCase() == "true"
                  ? !0
                  : !1,
              fullscreen: !1,
              repeat: "",
          ...
          _media,
          _eventDispatcher = new jwplayer.html5.eventdispatcher(),
        ...
        for (var option in options) {
          ...
          for (var edge in path)
            edge == path.length - 1
              ...
              : (jwplayer.utils.exists(config[path[edge]]) ||
                  (config[path[edge]] = {}),
        ...
        if (
          ...
          typeof _model.plugins == "string"
        ) {
          var userplugins = _model.plugins.split(",");
          for (var userplugin in userplugins)
            typeof userplugins[userplugin] == "string" &&
              pluginorder.push(
        ...
        jwplayer.utils.isMobile()
          ? ((pluginorder = ["display", "logo", "dock", "playlist"]),
            jwplayer.utils.exists(_model.config.repeat) ||
              (_model.config.repeat = "list"))
          : _model.config.chromeless &&
        ...
        for (var pluginIndex in _model.plugins.order) {
          var pluginName = _model.plugins.order[pluginIndex],
            pluginConfig = jwplayer.utils.exists(
          ...
          (_model.plugins.config[pluginName] = jwplayer.utils.exists(
            ...
            jwplayer.utils.exists(_model.plugins.config[pluginName].position)
              ? (pluginName == "playlist" && (playlistVisible = !0),
        ...
        _model.plugins.config.controlbar &&
          playlistVisible &&
          (_model.plugins.config.controlbar.hideplaylistcontrols = !0);
        if (typeof _model.plugins.config.dock != "undefined") {
          if (typeof _model.plugins.config.dock != "object") {
            var position = _model.plugins.config.dock.toString().toUpperCase();
            _model.plugins.config.dock = { position: position };
          }
          typeof _model.plugins.config.dock.position != "undefined" &&
        ...
        _model.loadPlaylist = function (arg) {
          ...
          (_model.playlist = new jwplayer.html5.playlist(config)),
            ...
            !_model.playlist[0].provider && _model.playlist[0].file
              ? _loadExternal(_model.playlist[0].file)
              : _loadComplete();
        };
        var _mediaProviders = {};
        return (
          (_model.setActiveMediaProvider = function (e) {
            ...
            if (!jwplayer.utils.exists(_mediaProviders[t])) {
              ...
              _media != _mediaProviders[t] &&
                (_media && _media.stop(), (_media = _mediaProviders[t]));
            return !0;
          }),
          ...
          (_model.seek = function (e) {
            return (
              _eventDispatcher.sendEvent(
                ...
                { position: _model.position, offset: e }
              ),
              _media.seek(e)
            );
          }),
          ...
          (_model.setupPlugins = function () {
            ...
            for (var e = 0; e < _model.plugins.order.length; e++)
              try {
                ...
                jwplayer.utils.exists(jwplayer.html5[t])
                  ? t == "playlist"
                    ? (_model.plugins.object[t] =
                        new jwplayer.html5.playlistcomponent(
                          _api,
                          _model.plugins.config[t]
                        ))
                    : (_model.plugins.object[t] = new jwplayer.html5[t](
                        _api,
                        _model.plugins.config[t]
                      ))
                  : _model.plugins.order.splice(plugin, plugin + 1),
                  typeof _model.plugins.object[t].addGlobalListener ==
                    "function" &&
                    _model.plugins.object[t].addGlobalListener(forward);
              } catch (n) {
      ...
      e.html5.playlist = function (t) {
        ...
        if (t.playlist && t.playlist instanceof Array && t.playlist.length > 0)
          for (var r in t.playlist)
            isNaN(parseInt(r)) ||
              n.push(new e.html5.playlistitem(t.playlist[r]));
        ...
        (e.html5.playlistcomponent = function (r, i) {
          ...
          function w(e) {
            return function () {
              ...
              e == s.jwGetPlaylistIndex() &&
                (o.activecolor !== "" && (n = o.activecolor),
                m.itemActive && (r = "url(" + m.itemActive.src + ")")),
                _css(t, {
                  color: o.overcolor !== "" ? o.overcolor : n,
                  backgroundImage: m.itemOver
                    ? "url(" + m.itemOver.src + ")"
                    : r,
                });
            };
          ...
          function E(e) {
            return function () {
              ...
              e == s.jwGetPlaylistIndex() &&
                (o.activecolor !== "" && (n = o.activecolor),
                m.itemActive && (r = "url(" + m.itemActive.src + ")")),
                _css(t, { color: n, backgroundImage: r });
            };
          }
          function S(t) {
            var n = h[t],
            ...
            var i = document.createElement("div"),
              ...
              p = 0;
            k() &&
              (n.image || n["playlist.image"] || m.itemImage) &&
              ((s.className = "image"),
              m.itemImage
                ? ((u = (o.itemheight - m.itemImage.height) / 2),
                  (c = m.itemImage.width),
                  (p = m.itemImage.height))
                : ((c = (o.itemheight * 4) / 3), (p = o.itemheight)),
              _css(i, {
                height: p,
                width: c,
                float: "left",
              ...
              n["playlist.image"]
                ? (s.src = n["playlist.image"])
                : n.image
                ? (s.src = n.image)
                : m.itemImage && (s.src = m.itemImage.src),
              r.appendChild(i));
            var d = f - c - u * 2;
          ...
          var s = r,
            o = e.utils.extend(
              {},
              t,
              s.skin.getComponentSettings("playlist"),
              i
            );
          if (
            o.position == e.html5.view.positions.NONE ||
            typeof e.html5.view.positions[o.position] == "undefined"
          )
            return;
          var u,
            f,
    ...
    (function (e) {
      function t(t) {
        ...
        var n = e.utils.extension(t.file),
          r;
      ...
      e.html5.playlistitem = function (n) {
        ...
        return (
          i.type && ((i.provider = i.type), delete i.type),
          i.levels.length === 0 &&
            (i.levels[0] = new e.html5.playlistitemlevel(i)),
          i.provider
            ? (i.provider = i.provider.toLowerCase())
            : (i.provider = t(i.levels[0])),
          i
        );
      };
    })(jwplayer),
        ...
        function n(n) {
          ...
          try {
            ...
            t.sendEvent(e.api.events.JWPLAYER_PLAYLIST_LOADED, {
              playlist: new e.html5.playlist({ playlist: i }),
            });
          } catch (s) {
      ...
      e.html5.skinloader = function (t, n, r) {
              ...
              for (var S = 0; S < E.length; S++) {
                ...
                for (var k = 0; k < C.length; k++) {
                  ...
                  for (var A = 0; A < L.attributes.length; A++) {
                    ...
                    i[s].layout[x.getAttribute("position")].elements[k][
                      O.name
                    ] = O.value;
                  }
                  e.utils.exists(
                    i[s].layout[x.getAttribute("position")].elements[k].name
                  ) ||
                    (i[s].layout[x.getAttribute("position")].elements[k].name =
                      L.tagName);
                }
        ...
        function v(t, n) {
          var r = new Image(),
            ...
            f;
          if (u.indexOf("data:image/png;base64,") === 0) f = u;
          else {
        ...
        function g() {
          for (var e in i)
            if (e != "properties")
              for (var t in i[e].elements) if (!i[e].elements[t].ready) return;
          u === !1 && (clearInterval(f), s(i));
        }
        function y(t, n, r) {
          i[r] && i[r].elements[n]
            ? ((i[r].elements[n].height = t.height),
              (i[r].elements[n].width = t.width),
              (i[r].elements[n].src = t.src),
              (i[r].elements[n].ready = !0),
              d())
            : e.utils.log(
                "Loaded an image for a missing element: " + r + "." + n
              );
        }
        var i = {},
          s = n,
    ...
    (function (e) {
      e.html5.api = function (t, n) {
        function f() {
          s.state == e.api.events.state.PLAYING ||
          s.state == e.api.events.state.BUFFERING
            ? u.pause()
            : u.play();
        }
        function l(e) {
        ...
        function d() {
          s.config.playlistfile
            ? (s.addEventListener(e.api.events.JWPLAYER_PLAYLIST_LOADED, v),
              s.loadPlaylist(s.config.playlistfile))
            : typeof s.config.playlist == "string"
            ? (s.addEventListener(e.api.events.JWPLAYER_PLAYLIST_LOADED, v),
              s.loadPlaylist(s.config.playlist))
            : (s.loadPlaylist(s.config), setTimeout(v, 25));
        }
        function v(t) {
        ...
        (r.skin = new e.html5.skin()),
          ...
          (r.jwDockSetButton = function (e, t, n, r) {
            s.plugins.object.dock &&
              s.plugins.object.dock.setButton &&
              s.plugins.object.dock.setButton(e, t, n, r);
          }),
        ...
        return (
          ...
          (r.jwInstreamRemoveEventListener = p(
            "jwInstreamRemoveEventListener"
          )),
          ...
          (r.jwLock = function () {}),
          (r.jwUnlock = function () {}),
          s.config.chromeless && !e.utils.isIOS()
            ? d()
            : r.skin.load(s.config.skin, d),
          r
        );
      };
    })(jwplayer);
...
(function (e, t) {
  ...
  return {
    best: function (e) {
      ...
      for (r = 0; r < t && "" !== e[r]; r++);
      if (r < n)
        for (e.splice(r, 1, "0000"); e.length < n; ) e.splice(r, 0, "0000");
      for (r = 0; r < n; r++) {
        for (var t = e[r].split(""), i = 0; 3 > i; i++) {
          if (!("0" === t[0] && 1 < t.length)) break;
          t.splice(0, 1);
        }
        e[r] = t.join("");
      }
  ...
  (function (e) {
    ...
    function s(e, t, n) {
      var r = 0;
      e = n ? N(e / g) : e >> 1;
      for (e += N(e / t); e > (T * v) >> 1; r += p) e = N(e / T);
    ...
    function o(e) {
      var n = [],
        ...
        g,
        E;
      (l = e.lastIndexOf(w)), 0 > l && (l = 0);
      for (c = 0; c < l; ++c)
        128 <= e.charCodeAt(c) && t("not-basic"), n.push(e.charCodeAt(c));
      for (l = 0 < l ? l + 1 : 0; l < r; ) {
        (c = u), (o = 1);
        for (m = p; ; m += p) {
          l >= r && t("invalid-input"),
    ...
    function u(e) {
      var n,
        ...
        S,
        x;
      (e = r(e)), (E = e.length), (n = b), (i = 0), (a = y);
      for (f = 0; f < E; ++f) (m = e[f]), 128 > m && g.push(C(m));
      for ((o = u = g.length) && g.push(w); o < E; ) {
        l = h;
        for (f = 0; f < E; ++f) (m = e[f]), m >= n && m < l && (l = m);
        (S = o + 1),
          l - n > N((h - i) / S) && t("overflow"),
          (i += (l - n) * S),
          (n = l);
        for (f = 0; f < E; ++f)
          if (((m = e[f]), m < n && ++i > h && t("overflow"), m == n)) {
            c = i;
            for (l = p; ; l += p) {
              m = l <= a ? d : l >= a + v ? v : l - a;
              if (c < m) break;
    ...
    if (l)
      if (c && c.exports == l) c.exports = a;
      else for (k in a) a.hasOwnProperty(k) && (l[k] = a[k]);
    else f ? define("punycode", a) : (e.punycode = a);
  })(this),
  (function (e, t) {
    "object" == typeof exports
      ? (module.exports = t())
  ...
  (function (e, t) {
    ...
    function u(e, t) {
      ...
      if (o(t)) {
        n = 0;
        for (r = t.length; n < r; n++) if (!u(e, t[n])) return !1;
        return !0;
      }
      var i = s(t);
      n = 0;
    ...
    for (p in h) r[p + "PathSegment"] = d("pathname", h[p]);
    (r.encodeReserved = d("reserved", "encode")),
      ...
      (r.parseQuery = function (e) {
        ...
        for (var n = e.length, i, s, o = 0; o < n; o++)
          (i = e[o].split("=")),
            ...
            t[s]
              ? ("string" == typeof t[s] && (t[s] = [t[s]]), t[s].push(i))
              : (t[s] = i);
        return t;
      }),
      (r.build = function (e) {
          ...
          if (c.call(e, s) && s)
            if (o(e[s])) {
              ...
              for (a = e[s].length; u < a; u++)
                void 0 !== e[s][u] &&
                  void 0 === i[e[s][u] + ""] &&
                  ((n += "&" + r.buildQueryParameter(s, e[s][u])),
                  !0 !== t && (i[e[s][u] + ""] = !0));
            } else
      ...
      (r.addQuery = function (e, t, n) {
        if ("object" == typeof t)
          for (var i in t) c.call(t, i) && r.addQuery(e, i, t[i]);
        else {
          if ("string" != typeof t)
            throw new TypeError(
      ...
      (r.removeQuery = function (e, t, n) {
        ...
        if (o(t)) {
          n = 0;
          for (i = t.length; n < i; n++) e[t[n]] = void 0;
        } else if ("object" == typeof t)
          for (i in t) c.call(t, i) && r.removeQuery(e, i, t[i]);
        else {
          if ("string" != typeof t)
            throw new TypeError(
          ...
          if (void 0 !== n) {
            if (e[t] === n) e[t] = void 0;
              ...
              if (o(n)) {
                u = 0;
                for (a = n.length; u < a; u++) s[n[u]] = !0;
              } else s[n] = !0;
              u = 0;
              for (a = i.length; u < a; u++)
                void 0 !== s[i[u]] && (i.splice(u, 1), a--, u--);
              e[t] = i;
            }
          } else e[t] = void 0;
        }
      ...
      (r.hasQuery = function (e, t, n, i) {
        if ("object" == typeof t) {
          for (var f in t)
            if (c.call(t, f) && !r.hasQuery(e, f, t[f])) return !1;
          return !0;
        }
        if ("string" != typeof t)
          throw new TypeError(
        ...
        switch (s(n)) {
          case "Undefined":
            return t in e;
          case "Boolean":
            return (e = Boolean(o(e[t]) ? e[t].length : e[t])), n === e;
          case "Function":
            return !!n(e[t], t, e);
          case "Array":
      ...
      (l.build = function (e) {
        if (!0 === e) this._deferred_build = !0;
        else if (void 0 === e || this._deferred_build)
          (this._string = r.build(this._parts)), (this._deferred_build = !1);
        return this;
      }),
      (l.clone = function () {
        return new r(this);
      }),
      (l.valueOf = l.toString =
        function () {
    ...
    for (p in h) l[p] = d(p, h[p]);
    (h = { search: ["?", "query"], hash: ["#", "fragment"] }),
      (d = function (e, t) {
        return function (n, r) {
          var i = this[e](n, r);
    ...
    (l.pathname = function (e, t) {
      ...
      (l.href = function (e, t) {
        ...
        if ("string" == typeof e) this._parts = r.parse(e, this._parts);
        else {
          if (!i && !s) throw new TypeError("invalid input");
          for (n in ((i = i ? e._parts : e), i))
    ...
    (l.protocol = function (e, t) {
      ...
      (l.domain = function (e, t) {
        ...
        if (void 0 === e) {
          ...
          return n && 2 > n.length
            ? this._parts.hostname
            : ((n = this._parts.hostname.length - this.tld(t).length - 1),
      ...
      (l.tld = function (e, t) {
        ...
        if (void 0 === e) {
          ...
          return !0 !== t && n && n.list[r.toLowerCase()]
      ...
      (l.segment = function (e, t, n) {
        ...
        s && i.shift(), 0 > e && (e = Math.max(i.length + e, 0));
        if (void 0 === t) return void 0 === e ? i : i[e];
        ...
        return s && i.unshift(""), this.path(i.join(r), n);
      });
    var y = l.query;
    return (
      (l.query = function (e, t) {
      ...
      (l.setQuery = function (e, t, n) {
        ...
        if ("object" == typeof e)
          for (var s in e) c.call(e, s) && (i[s] = e[s]);
        else {
          if ("string" != typeof e)
            throw new TypeError(
              "URI.addQuery() accepts an object, string as the name parameter"
      ...
      (l.addQuery = function (e, t, n) {
        var i = r.parseQuery(this._parts.query);
        return (
          r.addQuery(i, e, void 0 === t ? null : t),
          (this._parts.query = r.buildQuery(
            i,
            this._parts.duplicateQueryParameters
          )),
      ...
      (l.normalizePath = function (e) {
        ...
        var t,
          ...
          s;
        "/" !== n.charAt(0) &&
          ("." === n.charAt(0) && n.substring(0, n.indexOf("/")),
          (t = !0),
          (n = "/" + n));
        for (n = n.replace(/(\/(\.\/)+)|\/{2,}/g, "/"); ; ) {
          i = n.indexOf("/../");
        ...
        return (
          t && this.is("relative") && (n = n.substring(1)),
          (n = r.recodePath(n)),
          (this._parts.path = n),
          this.build(!e),
          this
      ...
      (l.readable = function () {
        ...
        if (t._parts.query) {
          for (
            var i = "", s = 0, o = t._parts.query.split("&"), u = o.length;
            s < u;
            s++
          ) {
            var a = (o[s] || "").split("="),
            ...
            void 0 !== a[1] &&
              (i += "=" + r.decodeQuery(a[1]).replace(/&/g, "%26"));
          }
          n += "?" + i.substring(1);
        }
        return (n += t.hash());
      ...
      (l.absoluteTo = function (e) {
        ...
        i = 0;
        for (s; (s = n[i]); i++) t._parts[s] = e._parts[s];
        (n = ["query", "path"]), (i = 0);
        for (s; (s = n[i]); i++)
      ...
      (l.relativeTo = function (e) {
        ...
        for (var o = 0, u; (u = n[o]); o++) t._parts[u] = null;
        if ("/" === s) return t;
        if (!s) return this.clone();
        (e = e.directory()), (n = t.directory());
        if (e === n) return (t._parts.path = t.filename()), t.build();
        e.substring(s.length), (n = n.substring(s.length));
        if (e + "/" === s)
          return n && (n += "/"), (t._parts.path = n + t.filename()), t.build();
        (n = "../"), (s = RegExp("^" + i(s)));
        for (e = e.replace(s, "/").match(/\//g).length - 1; e--; ) n += "../";
        return (t._parts.path = t._parts.path.replace(s, n)), t.build();
      }),
      (l.equals = function (e) {
        var t = this.clone();
        e = new r(e);
        ...
        (n = t.query()), (i = e.query()), t.query(""), e.query("");
        if (t.toString() !== e.toString() || n.length !== i.length) return !1;
        (n = r.parseQuery(n)), (i = r.parseQuery(i));
        for (u in n)
          if (c.call(n, u)) {
            if (o(n[u])) {
              if (!a(n[u], i[u])) return !1;
            } else if (n[u] !== i[u]) return !1;
            s[u] = !0;
          }
        for (u in i) if (c.call(i, u) && !s[u]) return !1;
        return !0;
      }),
  ...
  (function (e, t) {
    "object" == typeof exports
      ? (module.exports = t(require("./URI")))
      : "function" == typeof define && define.amd
      ? define(["./URI"], t)
      : (e.URITemplate = t(e.URI));
  })(this, function (e) {
    function t(e) {
      return t._cache[e]
        ? t._cache[e]
        : this instanceof t
        ? ((this.expression = e), (t._cache[e] = this), this)
        : new t(e);
    }
    function n(e) {
    ...
    return (
      ...
      (t.expandNamed = function (t, n, r, i, s, o) {
        ...
        for (d = t.val.length; p < d; p++)
          s
            ? ((h = e[a](t.val[p][1].substring(0, s))),
              2 === t.type && (c = e[a](t.val[p][0].substring(0, s))))
            : l
            ? ((h = e[a](t.val[p][1])),
              2 === t.type
                ? ((c = e[a](t.val[p][0])), t[a].push([c, h]))
                : t[a].push([void 0, h]))
            : ((h = t[a][p][1]), 2 === t.type && (c = t[a][p][0])),
            u && (u += i),
            r
              ? (u += c + (n || h ? "=" : "") + h)
              : (p || (u += e[a](o) + (n || h ? "=" : "")),
      ...
      (t.expandUnnamed = function (t, n, r, i, s) {
        ...
        for (p = t.val.length; h < p; h++)
          s
            ? (c = e[u](t.val[h][1].substring(0, s)))
            : a
            ? ((c = e[u](t.val[h][1])),
              t[u].push([2 === t.type ? e[u](t.val[h][0]) : void 0, c]))
            : (c = t[u][h][1]),
            o && (o += i),
            2 === t.type &&
              ((l = s ? e[u](t.val[h][0].substring(0, s)) : t[u][h][0]),
              (o += l),
              (o = r ? o + (n || c ? "=" : "") : o + ",")),
            (o += c);
        return o;
      ...
      (i.expand = function (e) {
        ...
        for (var i = 0, s = this.parts.length; i < s; i++)
          r +=
            "string" == typeof this.parts[i]
              ? this.parts[i]
              : t.expand(this.parts[i], e);
        return r;
      }),
      (i.parse = function () {
        var e = this.expression,
          n = t.EXPRESSION_PATTERN,
          r = t.VARIABLE_PATTERN,
          i = t.VARIABLE_NAME_PATTERN,
          o = [],
          u = 0,
          a,
          f,
        ...
        for (n.lastIndex = 0; ; ) {
          ...
          o.push(e.substring(u, f.index)), (u = f.index + f[0].length);
          if (!s[f[1]])
            throw Error('Unknown Operator "' + f[1] + '" in "' + f[0] + '"');
          if (!f[3]) throw Error('Unclosed Expression "' + f[0] + '"');
          a = f[2].split(",");
          for (var c = 0, h = a.length; c < h; c++) {
            ...
            if (l[1].match(i))
              throw Error(
                'Invalid Variable Name "' + l[1] + '" in "' + f[0] + '"'
              );
            a[c] = {
              name: l[1],
              explode: !!l[3],
          ...
          o.push({ expression: f[0], operator: f[1], variables: a });
        }
        return o.length || o.push(e), (this.parts = o), this;
      }),
      (n.prototype.get = function (e) {
        var t = this.data,
          n = { type: 0, val: [], encode: [], encodeReserved: [] },
          i;
        if (void 0 !== this.cache[e]) return this.cache[e];
        (this.cache[e] = n),
          (t =
            "[object Function]" === String(Object.prototype.toString.call(t))
              ? t(e)
              : "[object Function]" ===
                String(Object.prototype.toString.call(t[e]))
              ? t[e](e)
              : t[e]);
        if (void 0 !== t && null !== t)
          if ("[object Array]" === String(Object.prototype.toString.call(t))) {
            ...
            for (e = t.length; i < e; i++)
              void 0 !== t[i] &&
                null !== t[i] &&
                n.val.push([void 0, String(t[i])]);
            n.val.length && (n.type = 3);
          } else if (
            "[object Object]" === String(Object.prototype.toString.call(t))
          ) {
            for (i in t)
              r.call(t, i) &&
                void 0 !== t[i] &&
                null !== t[i] &&
                n.val.push([i, String(t[i])]);
            n.val.length && (n.type = 2);
          } else (n.type = 1), n.val.push([void 0, String(t)]);
        return n;
      }),
  ...
  (function (e, t) {
    ...
    function r(t) {
      var n;
      return (
        e.each(["src", "href", "action"], function (e, r) {
          return r in t ? ((n = r), !1) : !0;
        }),
          ...
          !i || (!i[5] && ":" !== i[2] && !o[i[2]])
            ...
            : ((a = e(t).uri()),
              i[5]
                ? a.is(i[5])
                : ":" === i[2]
                ? ((u = i[1].toLowerCase() + ":"), o[u] ? o[u](a, i[4]) : !1)
                : ((u = i[1].toLowerCase()),
    ...
    var s = {},
      o = {
        ...
        "*=": function (e, t, r) {
          return (
            "directory" == r && (e += "/"), !!(e + "").match(RegExp(n(t), "i"))
          );
        },
        "equals:": function (e, t) {
          return e.equals(t);
    ...
    e.each(
      "authority directory domain filename fragment hash host hostname href password path pathname port protocol query resource scheme search subdomain suffix tld username".split(
        " "
      ),
      function (t, n) {
        (s[n] = !0),
    ...
    e.each(["src", "href", "action", "uri"], function (t, n) {
      ...
      (e.fn.uri = function (e) {
        ...
        if (!s)
          throw Error(
            'Element "' +
              i.nodeName +
              '" does not have either property: href, src, action'
          );
        if (void 0 !== e) {
          var o = n.data("uri");
          if (o) return o.href(e);
      ...
      (t.prototype.build = function (e) {
        ...
        else if (!0 === e) this._deferred_build = !0;
        else if (void 0 === e || this._deferred_build)
          (this._string = t.build(this._parts)), (this._deferred_build = !1);
        return this;
      });
    var a,
      f = /^([a-zA-Z]+)\s*([\^\$*]?=|:)\s*(['"]?)(.+)\3|^\s*([a-zA-Z0-9]+)\s*$/;
    return (
      (a = e.expr.createPseudo
  ...
  function () {
    ...
    (initialized = !1),
        ...
        return browserSupportsPushState
          ? (cacheCurrentPage(),
            ...
            n
              ? (changePage(
                  n.title,
                  createDocument("<html>" + n.body + "</html>").body
                ),
                recallScrollPosition(n),
                n.popCallback && n.popCallback(),
                triggerEvent("page:restore"),
                (pageBookmarks[t] = null))
              : fetchReplacement(e))
          : (document.location.href = e);
      }),
      ...
      (applyFetchReplacement = function (e) {
        var t;
        return (
          (t = createDocument(e.responseText)),
          assetsChanged(t)
            ? (document.location.href = url)
            : (changePage.apply(null, extractTitleAndBody(t)),
      ...
      (fetchHistory = function (e) {
        ...
        return (
          cacheCurrentPage(),
          (t = pageCache[e.position])
            ? (changePage(
                t.title,
                createDocument("<html>" + t.body + "</html>").body
              ),
      ...
      (cacheCurrentPage = function (e) {
        return (
          ...
          $(".turbolink_scroller").length > 0 &&
            ((pageCache[currentState.position].positionXTS = $(
              ".turbolink_scroller"
            ).scrollLeft()),
            (pageCache[currentState.position].positionYTS = $(
              ".turbolink_scroller"
            ).scrollTop())),
          this.TurbolinkPopCallback &&
            ((pageCache[currentState.position].popCallback =
              this.TurbolinkPopCallback),
      ...
      (executeScriptTags = function () {
        ...
        (ref = document.body.getElementsByTagName("script")), (results = []);
        for (i = 0, len = ref.length; i < len; i++)
          (script = ref[i]),
            ((ref1 = script.type) === "" || ref1 === "text/javascript") &&
        ...
        if (e !== document.location.href)
          return (
            ...
            window.history.pushState(
              { turbolinks: !0, position: currentState.position + 1 },
              "",
              e
            )
          );
      ...
      (rememberCurrentUrl = function () {
        return window.history.replaceState(
          { turbolinks: !0, position: window.history.length - 1 },
          "",
      ...
      (recallScrollPosition = function (e) {
        ...
        if (
          (e.positionXTS || e.positionYTS) &&
          $(".turbolink_scroller").length > 0
        )
          return (
            $(".turbolink_scroller").scrollLeft(e.positionXTS),
      ...
      (extractAssets = function (e) {
        ...
        for (t = 0, n = i.length; t < n; t++)
          (r = i[t]), (r.src || r.href) && s.push(r.src || r.href);
        return s;
      }),
      (assetsChanged = function (e) {
        return (
          intersection(extractAssets(e), assets).length !== assets.length, !1
        );
      }),
      (intersection = function (e, t) {
        var n, r, i, s, o;
        e.length > t.length && ((i = [t, e]), (e = i[0]), (t = i[1])), (s = []);
        for (n = 0, r = e.length; n < r; n++)
          (o = e[n]), indexOf.call(t, o) >= 0 && s.push(o);
        return s;
      }),
          ...
          if (t != null && t.nodeName === "A" && !ignoreClick(e, t))
            return (
              document
                ...
                .className.match(/no-replace-state/) && (initialized = !0),
              t.getAttribute("data-save-bookmark")
                ? visitAndSaveBookmark(
                    t.href,
                    t.getAttribute("data-save-bookmark")
                  )
                : t.getAttribute("data-load-bookmark")
                ? visitOrLoadBookmark(
                    t.href,
                    t.getAttribute("data-load-bookmark")
                  )
      ...
      (nonHtmlLink = function (e) {
        return (
          e.href.match(/\.[a-z]+(\?.*)?$/g) && !e.href.match(/\.html?(\?.*)?$/g)
        );
      }),
      (noTurbolink = function (e) {
        var t;
        while (!t && e !== document)
          (t = e.getAttribute("data-no-turbolink") != null), (e = e.parentNode);
        return t;
      }),
    ...
    jQuery(function (e) {
      ...
      if (e("time b")[0] != null) {
        ...
        if (e("body").hasClass("eu") || e("body").hasClass("japan"))
          e("body").hasClass("shop-closed") ||
          e("body").hasClass("products") ||
          e("body").hasClass("cart") ||
          e("body").hasClass("cart_page")
            ? e("#time-zone-name").text(
                e("body").hasClass("eu") ? "LDN" : "TYO"
              )
            : ((t = realNycOffset * 1e3), e("#time-zone-name").text("Irvine"));
        return (
          (n = null),
          (i = function (e, t) {
            var n;
  ...
  function () {
    ...
    (this.Turbolinks.__atomgas_doLater__ = function (e, t) {
      ...
      (n = {
        init: function () {
          ...
          this.setupTransitions(),
            ...
            this.storeLocation(),
            n.setCurrentLangToggle(n.currentLang()),
            (e = location.search.match(/utm_medium=([a-z]+)/)) &&
              $.cookie("origin", e[1]);
        ...
        setCurrentLang: function (e) {
          return (
            $.cookie("lang", e, { path: "/" }),
            $.cookie("langChanged", 1, { path: "/" })
          );
        },
        currentLang: function () {
          var e;
          return (e = "en"), $.cookie("lang") === null ? e : $.cookie("lang");
        },
        storeLocation: function () {
          return (
            (this.previousLocationPathname =
        ...
        showLanguageSetter: function (e, t) {
          ...
          return (
            (r = $(
              '<ul id="language-setter"><li class="en">UK</li><li class="de">DE</li><li class="fr">FR</li></ul>'
            )),
            r.attr("class", n.currentLang()),
            $("body").append(r),
            (i = $("#language-setter")),
            i.css({ top: e - i.height() - 6, left: t }),
            i.animate({ opacity: 1 }, 100, function () {
              return (
                ...
                $("body").on(
                  ...
                  (function (e) {
                    return function (e) {
                      ...
                      return (
                        n.hideLanguageSetter(), e.stopImmediatePropagation(), !1
                      );
                    };
                  })(this)
                )
        ...
        hideLanguageSetter: function () {
          return (
            $("body").unbind("click.langSetter"),
            $("#language-setter").animate({ opacity: 0 }, 0, function () {
              return $(this).remove();
            })
          );
        },
        ...
        hideCookieNotice: function () {
          var e;
          return (
            $.cookie("hasShownCookieNotice", 1, { expires: 525600 }),
            (e = $("#top_notice")),
            e.removeClass("show")
          );
        },
          ...
          return (
            ...
            (r = {
              ...
              fadeOut: (function (t) {
                return function () {
                  return (
                    $("#wrap > *").animate({ opacity: 0 }, e, function () {
              ...
              fadeIn: function (t) {
                t || (t = {}),
                  ...
                  $("#wrap").css({ opacity: 1 }).removeClass("loading"),
                  $("#wrap > *:not(footer,object,embed,.arrow)")
                    .css({ opacity: 0 })
                    .animate({ opacity: 1 }, e);
                if (t.headerAndFooter == null)
                  return $("header, footer").animate({ opacity: 1 }, e);
              },
            }),
            location.host.split(".")[0] !== "archive" &&
                  ...
                  return (
                    ...
                    ),
                    {
                      background: function () {
                        var e;
                        return (
                          (e = $("body").css("backgroundColor")),
                          $("body")
                            .css({ backgroundColor: "#000" })
                            .animate({ backgroundColor: "#FFF" }, t)
                        );
                      },
              ...
              this.addTransition("* -> HOME", {
                ...
                fadeIn: function () {
                  return (
                    $("header").show(),
                    $("body")
                      .css({ opacity: 0, backgroundColor: "#FFF" })
                      .animate({ opacity: 1, backgroundColor: "#000" }, t),
                    r.fadeIn()
                  );
                },
              })),
            ...
            this.addTransition("PRODUCT -> STYLE", {
              ...
              fadeOut: "",
              fadeIn: function () {
                return $("article figure img").css({ opacity: 1 });
              },
        ...
        performTransition: function (t, r, i) {
          ...
          if ($.type(s) === "string")
            return (
              ...
              t === "fadeOut"
                ? ((u = 1), (o = 0))
                : $(r.loader || "#wrap").removeClass("loading"),
              i && n.performExtraFadeIns(i),
              $(s)
                .css({ opacity: u })
                .animate({ opacity: o }, e, function () {
                  if (t === "fadeOut")
                    return $(r.loader || "#wrap").addClass("loading");
                }),
              {}
            );
          if ($.type(s) === "function") return s(i);
        ...
        performfadeOut: function () {
          var e;
          return (
            (e = this.transitionFor(
              "fadeOut",
              this.currentLocationPathname,
              location.pathname
            )),
      ...
      jQuery(function () {
        if (this.Supreme == null) return n.init(), (this.Supreme = n);
      });
  }.call(this),
  function () {
    var e,
    ...
    (t = /^([^\/@\s\\]+)@((?:[-a-z0-9]+\.)+[a-z]{2,})$/i),
      ...
      (e = function (e) {
        var r;
        return (
          (r = e.val()), /email/.test(e.attr("id")) ? t.test(r) : !n.test(r)
        );
      }),
      (r = function () {
        var t, n, s, o, u, a, f;
        (f = 1 <= arguments.length ? i.call(arguments, 0) : []), (r = !0);
        for (s = 0, u = f.length; s < u; s++)
          (a = f[s]),
            (o = $("#" + a)),
            (n = (t = o.data("error-display")) ? $(t) : o.parent()),
            e(o) ? n.removeClass("error") : ((r = !1), n.addClass("error"));
        return r;
      }),
      (this.Validator = { valid: r });
  }.call(this),
  function () {
    var e = function (e, t) {
      return function () {
    ...
    this.BaseImageViewer = (function () {
      function t(t, n, r, i, s) {
        ...
        (this.controller = t),
          ...
          (this.urlsLoaded = []),
          BaseImageController.isTouchDevice() ||
      ...
      return (
        (t.prototype.clickListener = function (e) {
          ...
          e.preventDefault(),
            (t = !0),
            document.body.classList.contains("lookbook") &&
          ...
          if (
            ...
            switch (this.mouseAction(e)) {
              case "prevImage":
                t && this.controller.showPrevImage();
                break;
              case "nextImage":
                t && this.controller.showNextImage();
                break;
              case "zoomImage":
        ...
        (t.prototype.initialImageLoaded = function () {
          var e;
          this.spinnerPromise.reject(), (e = $(this.imageSelector));
          if (e[0] != null) return this.showInitialImage();
        }),
        ...
        (t.prototype.showImage = function (e) {
          var t, n;
          (n =
            this.controller.zoomedImageUrl(this.index) ||
            this.controller.imageUrl(this.index)),
            (t = this.controller.caption(this.index));
          if ($(this.imageSelector).attr("src") !== n)
            return this.imageLoader.loadImage({
              ...
              displayCompletedCallback: (function (e) {
                return function (n) {
                  return (
                    $(n).attr("alt", "" + t),
                    (e.controller.isChangingImage = !1)
                  );
                };
              })(this),
        ...
        (t.prototype.mouseAction = function (e) {
          if (!this._mousePositionActionsEnabled) return "noop";
          if ($(".lookbook")[0] && e.target.classList.contains("nav-image"))
            return "hidden";
          if (e.pageX < $(window).width() / 3) {
            if (this.controller.hasPrevImage()) return "prevImage";
          } else if (e.pageX > ($(window).width() / 3) * 2) {
            if (this.controller.hasNextImage()) return "nextImage";
          } else if (this.controller.hasZoom()) return "zoomImage";
        }),
        ...
        (t.prototype.mouseDownListener = function (e) {
          ...
          if (t[0] != null && typeof t.attr("class") != "undefined")
            return (
              t.attr("class", t.attr("class").replace("-down", "")),
    ...
    this.PreviewImageViewer = (function (n) {
      function r(t, n, i, s, o) {
        (this.setPageDimensions = e(this.setPageDimensions, this)),
          ...
          (this.showImage = e(this.showImage, this)),
          (this.imageDidLoad = e(this.imageDidLoad, this)),
          (this.calculatePageDimensions = e(
      ...
      return (
        ...
        (r.prototype.calculatePageDimensions = function () {
          ...
          return (
            ...
            $(window).height() > 800
              ? ((e.wrapHeight = $(window).height() - 25),
                e.wrapHeight > t && (e.wrapHeight = t),
                (e.headerNegativeMargin = -((e.wrapHeight + 30) / 2)))
              : ((e.wrapHeight = $(window).height() - 65),
        ...
        (r.prototype.imageDidLoad = function (e) {
          var t, n, i;
          return (
            (i = this.calculatePageDimensions()),
        ...
        (r.prototype.showImage = function (e) {
          ...
          return (
            (t =
              this.controller.zoomedImageUrl(this.index) ||
              this.controller.imageUrl(this.index)),
            $(this.imageSelector).attr("src") !== t && t.match(/\.(mp4|flv)$/)
              ? this.imageLoader.loadVideo({
                  url: t,
        ...
        (r.prototype.mouseAction = function (e) {
          ...
          if (e.pageX < $("div.movie:visible").offset().left) {
            ...
            e.pageX >
              $("div.movie:visible").offset().left +
                $("div.movie:visible").width() &&
            this.controller.hasNextImage()
          )
            return "nextImage";
        }),
        (r.prototype.resizeImage = function (e, t) {
          var n, r, i;
          return (
            (i = this.controller.getImageDataRecord(e) || {}),
            (r = $(window).width() - 42),
            i.customDefaultWidth
              ? (r = i.customDefaultWidth < r ? i.customDefaultWidth : r)
              : i.customDefaultHeight || (r > 1200 && (r = 1200)),
            (n = t.containerHeight - 10),
            i.customDefaultHeight
              ? (n = i.customDefaultHeight < n ? i.customDefaultHeight || n : n)
              : i.customDefaultWidth || (n > 700 && (n = 700)),
            BaseImageController.resizeImageToAspectFit(e, r, n)
          );
        }),
        (r.prototype.setPageDimensions = function (e) {
          return (
            $("#wrap").css({ height: e.wrapHeight }),
            $("#container").css({
    ...
    this.PreviewTouchImageViewer = (function (n) {
      function r(t, n, i, s, o, u) {
        (this.swipeCallback = e(this.swipeCallback, this)),
          ...
          (this.resizeImage = e(this.resizeImage, this)),
          (this.positionAndAdjustFooter = e(
            this.positionAndAdjustFooter,
            this
          )),
          (this.positionAndAdjustHeader = e(
        ...
        r.__super__.constructor.call(this, t, n, i, s, o),
          ...
          (c = (function () {
            ...
            for (e = 0, t = n.length; e < t; e += 1)
              (l = n[e]),
                (l.zoomedImageUrl || l.imageUrl).match(/\.(mp4|flv)$/)
                  ? ((h = l.customDefaultWidth || 1024),
                    (f = l.customDefaultHeight || 576),
                    h > 938 && (f = Math.ceil((f * 938) / h)),
                    r.push(
                      '<li><div class="movie" id="img-main" style="height:' +
                        f +
                        'px"><div id="tmp_video" data-video="' +
                        (l.zoomedImageUrl || l.imageUrl)
                          .split("/")
                          .reverse()[0] +
                        '"></div></div>'
                    ))
          ...
          $("#slider ul li").css({ verticalAlign: "middle" }),
      ...
      return (
                ...
                return function () {
                  return $.each(e.find("ul li img"), function (e, n) {
                    return (
                      ...
                      $(n).show(),
                      $(n).parent().css({ verticalAlign: "middle" })
                    );
                  });
                };
              })(this),
        ...
        (r.prototype.positionAndAdjustHeader = function () {
          var e, t, n;
          (n = { width: $("#slider").width(), height: $("#slider").height() }),
            (e = 85),
            (t = ($(window).height() - n.height - e) / 2);
          if (!this.isMobileBreakpointActive())
            return $("#header").css({ height: t, margin: 0 });
        }),
        (r.prototype.positionAndAdjustFooter = function () {
          var e;
          return this.isMobileBreakpointActive()
            ? (this.isLandscape()
                ? (e = 0)
                : (e = $("#container").height() / 17.5),
              $("#wrap #container").css({ height: "auto" }),
              $("#wrap footer").show())
            : (this.isLandscape()
                ? (e = $(window).height() * 0.06)
                : (e = $("#container").height() / 17.5),
              $("#wrap #container").css({ height: "auto", marginBottom: e }),
              $("#wrap footer").show());
        }),
        (r.prototype.resizeImage = function (e) {
          ...
          if (!this.isMobileBreakpointActive())
            return (
              ...
              t &&
                t.customDefaultWidth &&
                t.customDefaultWidth < n.width &&
                (n.width = t.customDefaultWidth),
              t &&
                t.customDefaultHeight &&
                t.customDefaultHeight < n.height &&
                (n.height = t.customDefaultHeight),
              BaseImageController.resizeImageToAspectFit(
                e,
                n.width - 4,
                n.height
              ),
              $(e).css({
                marginTop: Math.max(
                  0,
                  $("#container[data-images]").height() / 2 - this.height / 2
                ),
              })
            );
        }),
        (r.prototype.sizeSlider = function () {
          ...
          return this.isMobileBreakpointActive()
            ? ((e = {
              ...
              $("#slider").css({ width: e.width }),
              $("#slider ul li").css({ width: e.width }))
            : ((e = {
                width: $(window).width(),
                height: window.innerHeight - 130,
              }),
              e.height > 700 && (e.height = 700),
              $("#slider").css({ width: e.width, height: e.height }),
              $("#slider ul").css({ height: e.height }),
              $("#slider ul li").css({ width: e.width, height: e.height }));
        }),
        (r.prototype.showImage = function (e) {
          this.swipe.slide(e),
            e < this.length - 1 &&
        ...
        (r.prototype.displayVideo = function () {
          var e, t;
          return (
            (t = $("#tmp_video").data("video")),
            (e = jwplayer("tmp_video").setup({
              file: "http://d3o425gsw3lvjf.cloudfront.net/" + t,
              image:
                "http://images.supremenewyork.com/assets/splash/" +
                t.replace(/\.(mp4|flv)$/, ".jpg") +
                "?c=2",
              modes: [
                {
                  type: "flash",
              ...
              width: "100%",
              height: "100%",
              skin: "https://d17ol771963kd3.cloudfront.net/assets/jwplayer/bekle/bekle.xml",
            }))
          );
        }),
        (r.prototype.setPageDimensions = function (e) {
        ...
        (r.prototype.swipeCallback = function () {
          (this.controller.isChangingImage = !1),
            ...
            this.controller.index === this.length - 1 &&
              $("#tmp_video").length > 0 &&
              this.displayVideo();
          if (
            this.controller.index < this.length - 1 &&
  ...
  function () {
    jQuery(function (e) {
      return (
        (window.mapsHaveLoaded = !1),
        (window.mapsLoadedCallback = function () {
          return (
            (window.mapsHaveLoaded = !0),
            e("body").trigger("mapsLoaded"),
            google.maps.event.addListenerOnce(map, "idle", function () {
              return (document.getElementsByTagName("iframe")[0].title =
                "Google Maps");
            })
          );
        }),
        (window.loadMaps = function () {
          ...
          return (
            ...
            (e.src =
              "//maps.googleapis.com/maps/api/js?key=AIzaSyCHovU5RCnW8ZSGNgL6LsbAIJMOAEWHf3o&sensor=false&v=3.10&callback=mapsLoadedCallback"),
    ...
    this.Marque = (function () {
      function t(t) {
        ...
        (this.selector = t),
          ...
          (this.timeoutId = null),
          (this.offset = -$(window).width()),
          (this.draggedItem = null),
          (this.otherItem = null),
          (this.draggedItemIndex = null),
          $("body").css({ padding: 0 }),
          (n = $(this.selector)),
          n.after(n.clone().data("clone", !0)),
          n.after(n.clone().data("clone", !0)),
          n.after(n.clone().data("clone", !0)),
          n.after(n.clone().data("clone", !0)),
          n.after(n.clone().data("clone", !0)),
          this.makeDraggable(n.parent().parent()),
          window.requestAnimationFrame(this.marquee),
          setTimeout(function () {
            return $(".scrollitem").css("opacity", 1);
          }, 100);
      }
      return (
        ...
        (t.prototype.makeDraggable = function (e) {
          return $(e).draggable({
            ...
            start: (function (e) {
              return function (t) {
                return (
                  (e.draggedItem = $(t.target)),
                  (e.draggedItemIndex = e.draggedItem.index()),
                  (e.otherItem =
                    e.draggedItemIndex === 0
                      ? $(e.selector + ":last-of-type")
                      : $(e.selector + ":first-of-type")),
                  (e.paused = !0),
                  !0
                );
              };
    ...
    jQuery(function () {
      ...
      return (
        ...
        $(document).on("submit", ".release_comment_form", function () {
          return (
            $('.release_comment_form input[type="submit"]').prop(
              "disabled",
              !0
            ),
            $.post(
              $(this).attr("action"),
              $(".release_comment_form").serialize(),
              function () {
                return (
                  $('.release_comment_form input[type="submit"]').prop(
                    "disabled",
                  ...
                  $(".release_comment_form").fadeOut(function () {
                    return $(".release_comment_form_successful").fadeIn(
                      function () {
                        return setTimeout(function () {
                          if (
                            $(".release_comment_form_successful").is(":visible")
                          )
                            return $(
                              ".release_comment_form_successful"
                            ).fadeOut();
                        }, 5e3);
                      }
                    );
        ...
        $("body").on("click", ".approve_release", function () {
          return (
            $(".approve_release").text() !== "Release approved" &&
        ...
        $("body").hasClass("eu") &&
          ($("body").hasClass("home") || $("body").hasClass("stores")) &&
          Supreme.showCookieNotice(),
        $("input, textarea").placeholder(),
        (n = function (e, t, n) {
          return (
            t == null && (t = $(window).width()),
            n == null && (n = $(window).height()),
            e.width / t > e.height / n
              ? (t = Math.round(n * (e.width / e.height)))
              : (n = Math.round(t / (e.width / e.height))),
            (e.width = t),
            (e.height = n)
          );
        }),
        (e = !1),
        (t = !1),
        $("body.home #background-image")[0]
          ? (e = $("body.home #background-image")[0])
          : $("body.home .bg-video-wrapper")[0] &&
            ((e = $("body.home .bg-video-wrapper")[0]), (t = !0)),
        e &&
          ((e.onload = function () {
            return (
              n(this),
              $(this).css({ display: "block" }).animate({ opacity: 1 }, 1200)
            );
          }),
          t
            ? $(e).css({ opacity: 0.35 })
          ...
          t ||
            $(window).on("resize", function () {
              return n($("#background-image")[0]);
            }),
          $(document).one("page:change", function () {
            return $(window).off("resize");
          }),
          $("body.home header").fadeIn(1e3).css({ display: "block" }),
          $("body.home #wrap").fadeIn(1e3),
          $("body.home").animate({ backgroundColor: "#000" }, 1e3)),
    ...
    jQuery(function (e) {
      return (
        (this.newsControlsCallback = function () {
          if (e(".news_container figure")[0] != null)
            return e(".news_container figure").each(
              (function (t) {
                return function (t, n) {
                  var r, i, s;
                  return (
                    e(n).addClass("controls_callback_applied"),
                    (i = null),
                    (t = null),
                    (s = function (s, o) {
                      var u;
                      return (u = function (u) {
                        return (
                          ...
                          e(o).animate({ opacity: 0 }, 500, function () {
                            return (
                              (this.onload = function () {
                                return (
                                  ...
                                  e(this).animate({ opacity: 1 })
                                );
                              }),
                              (this.src = i[t])
                            );
                          }),
                          e(o).parent().attr("href") &&
                            e(o)
                              .parent()
                              .attr(
                                "href",
                    ...
                    (r = function (t) {
                      e(n)
                        .parent(".news_container")
                        .find(".controls .back")
                        [t < 1 ? "addClass" : "removeClass"](
                          "hidden-placeholder"
                        ),
                        e(n)
                          .parent(".news_container")
                          .find(".controls .forward")
                          [t < i.length - 1 ? "removeClass" : "addClass"](
                            "hidden-placeholder"
                          ),
                        e(n)
                          .parent(".news_container")
                          ...
                          .html(t + 1),
                        i[t].title != null &&
                          e("footer .description h2").html(i[t].title);
                      if (i[t].caption != null)
                        return e("footer .description p").html(i[t].caption);
                    }),
                    e(n)
                      .parent(".news_container")
                      .find(".controls a")
                      .attr("data-no-turbolink", ""),
                    (i = e(n).data("image-urls")),
                    (t = e(n).data("index")),
                    e(n)
                      .parent(".news_container")
                      .find(".controls .back")
                      .on("click", s(-1, "#" + e(n).attr("id") + " img")),
                    e(n)
                      .parent(".news_container")
                      .find(".controls .forward")
                      .on("click", s(1, "#" + e(n).attr("id") + " img"))
        ...
        document.addEventListener("page:restore", this.newsControlsCallback)
      );
    });
  }.call(this),
  function () {
    jQuery(function (e) {
      ...
      if (e("body.stores")[0] != null)
        return (
          window.loadMaps(),
          (n = {
            store_1: { lat: 40.721094, lng: -73.993906 },
            store_2: { lat: 34.079298, lng: -118.361576 },
            store_3: { lat: 35.65312923421094, lng: 139.7053174674511 },
            store_4: { lat: 34.67107367572279, lng: 135.49581840634346 },
            store_5: { lat: 33.5872943, lng: 130.3944053 },
            store_6: { lat: 35.6691815041263, lng: 139.70672965049744 },
            store_7: { lat: 35.166156, lng: 136.904849 },
            store_8: { lat: 51.512704, lng: -0.134369 },
            store_9: { lat: 35.66268558323531, lng: 139.69990074634552 },
            store_10: { lat: 48.8592932, lng: 2.3604969 },
            store_11: { lat: 40.7145752, lng: -73.9622777 },
            store_13: { lat: 37.7819123, lng: -122.4106241 },
            store_14: { lat: 45.47347, lng: 9.18403 },
            store_15: { lat: 52.5291481, lng: 13.4070015 },
          }),
          (t = function (t) {
            var n;
            return (
          ...
          (r = function (e) {
            if (e.currentTarget.classList.contains("japan")) {
              window.location.href = "/stores/japan";
              return;
            }
          ...
          (s = function (t, n) {
            return (
              e("#store-modal")
                ...
                .attr("tabindex", -1)
                .focus(),
              e("#stores-list").attr("aria-hidden", "true"),
              e("#header").attr("aria-hidden", "true"),
              e("#nav").attr("aria-hidden", "true"),
              e("#header").find("a").attr("tabindex", -1),
              e("#nav").find("a").attr("tabindex", -1),
              setTimeout(d, 100, t, n)
            );
          }),
          (o = function () {
            var t;
            return (
              e("#stores-list").removeAttr("aria-hidden"),
              e("#header").removeAttr("aria-hidden").attr("tabindex", -1),
              e("#nav").removeAttr("aria-hidden").attr("tabindex", -1),
              e("#header").find("a").removeAttr("tabindex"),
              e("#nav").find("a").removeAttr("tabindex"),
              (t = e("#store-modal")),
              t.removeAttr("aria-modal").removeAttr("tabindex"),
          ...
          (l = function (e) {
            var t;
            return (t = new Date().getTime()), "store-map-" + e + "-" + t;
          }),
          (a = function (e) {
            return {
              zoom: 16,
          ...
          (c = function (n) {
            var r, i, o;
            return e(n.currentTarget).data("store-path")
              ? this.Turbolinks.visit(
                  window.location.href.replace(
                    "/stores",
                    e(n.currentTarget).data("store-path")
                  )
                )
              : ((o = e(n.currentTarget).data("store-id")),
                (r = e("#store-modal")),
                r.children(".address").html(t(n.currentTarget)),
                r
                  .children("img")
                  .attr("src", e(n.currentTarget).data("zoomed-image")),
                r.css(
                  "top",
                  e("li.store img").offset().top - e(window).scrollTop() + "px"
                ),
                n.preventDefault(),
                (i = l(o)),
          ...
          (h = function (e) {
            if (
              e.target.id === "store-modal-background" ||
              e.target.className === "spacer"
            )
              return u();
          }),
          (p = function (e) {
          ...
          (d = function (t, n) {
            return window.mapsHaveLoaded
              ? i(t, n)
              : e("body").one("mapsLoaded", function () {
                  return i(t, n);
                });
          }),
          e("li.store").on("click", r),
  ...
  (Swipe.prototype = {
      ...
      t == undefined && (t = this.speed),
        (n.webkitTransitionDuration =
          ...
          n.transitionDuration =
            t + "ms"),
        (n.MozTransform = n.webkitTransform =
          "translate3d(" + -(e * this.width) + "px,0,0)"),
        (n.msTransform = n.OTransform =
        ...
        typeof this.isScrolling == "undefined" &&
          (this.isScrolling = !!(
            ...
            Math.abs(this.deltaX) <
              Math.abs(e.touches[0].pageY - this.start.pageY)
          )),
        this.isScrolling ||
          (e.preventDefault(),
          clearTimeout(this.interval),
    ...
    onTouchEnd: function (e) {
      ...
      this.isScrolling ||
        this.slide(
          this.index + (t && !n ? (this.deltaX < 0 ? 1 : -1) : 0),
          this.speed
        ),
        e.stopPropagation();
    },
    ...
    (e = function () {
      ...
      if ($("#lookbook-items")[0] != null)
        return (
          (t = (function () {
            var t, n, r, i;
            (r = $("#lookbook-items li [data-image-url]")), (i = []);
          ...
          (n = new this.LookBookImageController(
            "#img-main",
            $("#img-main-link").data("index"),
            t,
            { fadeSmallImage: !1 }
          )),
          $("#lookbook-items ul").height() > 546 &&
            $("#lookbook-items").addClass("scroll"),
          (r = new Image()),
          (r.onload = function () {
            var e, t;
            return (
              (e = r.height),
              (t = r.width),
              $("#lookbook-items ul li img")
                .toArray()
                .map(function (n) {
                  return (
                    (n.style.width = (57 * t) / e + "px"), (n.style.opacity = 1)
                  );
                })
            );
          }),
          (r.src = $("#lookbook-items ul img")[0].src)
        );
    }),
      jQuery(document).ready(e),
      document.addEventListener("page:restore", e.bind(this));
  }.call(this),
  function () {
    var e,
      t,
    ...
    (h = {}),
      ...
      (g = function () {
        return (
          $("#shop-scroller-container").scrollLeft() +
            $("#shop-scroller-container").width() >=
          $("#shop-scroller").width()
        );
      }),
      (m = function () {
      ...
      (y = function () {
        if ($(".cart_page").length === 0) return;
        return (
          $(".cart-remove-form")
            .unbind("submit.remove")
            .bind("submit.remove", n),
          $(".cart-qty-form").unbind("submit.qty").bind("submit.qty", t),
          $(".cart-qty-form select").unbind("change.qty").bind("change.qty", e)
        );
      }),
      (n = function (e) {
        var t, n;
        return (
          ...
          (t = $(this).serialize()),
          e.preventDefault(),
          $.ajax({ url: n, data: t, type: "DELETE" }).done(
            (function (e) {
              return function (t) {
                var n, r, i, o;
                s(t.total),
                  ...
                  (o = i[1]),
                  (n = i[2]),
                  $(".subtotal-span").text(o),
                  $("#cart-header #items-count").html(r.replace("+", " ")),
                  $(e).closest("tr").fadeOut(500);
                if (l())
                  return P(
                    location.protocol + "//" + location.hostname + "/shop"
                  );
              };
            })(this)
          )
      ...
      (t = function (e) {
        ...
        return (
          ...
          (t = $(this).serialize()),
          e.preventDefault(),
          $.ajax({ url: n, data: t, type: "PUT" }).done(
            (function (e) {
              return function (t) {
                var n, r, i, o;
                return (
                  ...
                  $(e)
                    .closest("tr")
                    .find(".cart-price-span")
                    .text(t.data.line_item_price)
                );
              };
            })(this)
          )
      ...
      (r = function (e) {
        return window.desktopAddToCartMod
          ? window.desktopAddToCartMod(
              window.productAddToCartFormSubmit,
              $(this),
              e
            )
          : window.productAddToCartFormSubmit($(this), e);
      }),
      (window.productAddToCartFormSubmit = function (e, t, n) {
        var r, i, o, u, a, f, l, c, h;
        return (
          (h = e.attr("action")),
          (u = e.serializeArray()),
          n
            ? (o = e.serialize() + "&cry=" + new URLSearchParams(n).toString())
            : (o = e.serialize()),
          (l = u.filter(function (e) {
            return e.name === "qty";
          })),
          (f = 1),
          l.length > 0 && (f = parseInt(l[0].value)),
          $(".price-sale") && $(".price-sale").text() !== ""
            ? (r = parseInt(
                $(".price-sale")
                  .text()
                  .replace(/[^0-9\.]/g, "")
          ...
          (a = JSON.parse($.cookie("pure_cart")) || {}),
          (c = 0),
          a.total && (c = +a.total.replace(/[^0-9\.]/g, "")),
          (i = c),
          isNaN(i) && (i = 0),
          (i += r * f),
          t.preventDefault(),
          $.post(h, o)
            .done(function (e) {
              return e.success
                ? (v(),
                  ga_track("Add to Cart Attempt", "mp_only"),
                  (Object.keys(a).length === e.cart.length + 1 ||
                    Object.keys(a).length === 0) &&
                    s(_curSymbol + i),
                  $(document).trigger("page:load"))
                : (C(), ga_track("Add to Cart Attempt", "mp_only"));
            })
            .fail(function (e) {
              return C();
            })
      ...
      (i = function (e) {
        ...
        return (
          ...
          (t = $(this).serialize()),
          e.preventDefault(),
          $.ajax({ url: n, data: t, type: "DELETE" }).done(function (e) {
            var t, n, r;
            return (
              (t = JSON.parse($.cookie("pure_cart")) || {}),
              (t.total = e.total),
              $.cookie("pure_cart", JSON.stringify(t), {
                expires: 15,
                path: "/",
              }),
              $(document).trigger("page:load"),
              ...
              typeof r != "undefined" && r !== null && r.abort(),
              (r = $.getScript(n, function (e, t, n) {
                return b();
              }))
            );
          }),
      ...
      (s = function (e) {
        ...
        return (
          (t = JSON.parse($.cookie("pure_cart")) || {}),
          (t.total = e),
          $.cookie("pure_cart", JSON.stringify(t), { expires: 15, path: "/" })
        );
      }),
      (b = function () {
        if (!$("body").hasClass("products")) return;
        return (
          $("#cart-add").unbind("submit.add").bind("submit.add", r),
          $("#cart-remove").unbind("submit.remove").bind("submit.remove", i)
        );
      }),
      (H = function (e) {
        var t, n, r, i, s, o, u;
        return (
          ...
          $(".arrow")
            .on("mousedown", function (e) {
              if ($(this).hasClass("left") && m()) return;
              if ($(this).hasClass("right") && g()) return;
              ...
              return function (e) {
                return (
                  ...
                  t
                    .stop()
                    .animate(
                      { scrollLeft: t.scrollLeft() + u },
                      400,
                      "easeOutCirc",
                      function () {
                        (D = !0), g() && o.removeClass("enabled");
                        if (m()) return s.removeClass("enabled");
                      }
                    )
                );
              };
                ...
                return (
                  ...
                  t
                    ...
                    .animate(
                      ...
                      "easeOutCirc",
                      function () {
                        (D = !0), m() && s.removeClass("enabled");
                        if (g()) return o.removeClass("enabled");
                      }
                    )
                );
              };
          ...
          t.on(
            ...
            (function (e) {
              return function () {
                g() && o.removeClass("enabled"),
                  m() && s.removeClass("enabled");
                if (D) return (x = t.scrollLeft());
              };
            })(this)
          ),
          o.on(
            ...
            (function (e) {
              return function (e) {
                return g() ? o.removeClass("enabled") : o.addClass("enabled");
              };
            })(this)
          ),
          o.on(
          ...
          s.on(
            ...
            (function (e) {
              return function (e) {
                return m() ? s.removeClass("enabled") : s.addClass("enabled");
              };
            })(this)
          ),
          s.on(
      ...
      (l = function () {
        ...
        return (
          ...
          (r = n[1]),
          (e = n[2]),
          ("" + t).length === 0 || /^0\s/.test("" + t)
        );
      }),
      (L = function (e, t) {
        var n, r, i, s;
        n = 0;
        for (r = 0, i = e.length; r < i; r++) (s = e[r]), f(s) && n++;
        return n >= t;
      }),
      (a = function (e) {
        var t, n, r, i, s, o, a, f, c;
        (o = u()), (r = o[0]), (c = o[1]), (n = o[2]);
        if (l()) return !1;
        f = (function () {
          var e, t, r, i;
          (r = n != null ? n.split("-") : void 0), (i = []);
          for (e = 0, t = r.length; e < t; e += 1)
            (s = r[e]), i.push(parseInt(s.split(",")[1], 10));
          return i;
        })();
        for (t = 0, i = e.length; t < i; t++) {
          a = e[t];
          if (j.call(f, a) >= 0) return !0;
        }
        return !1;
      }),
      (f = function (e) {
      ...
      (o = function (e) {
        ...
        return (
          (n = (function () {
            var e, n, r, i;
            (r = $(
              "body.products ul.styles a, body.products ul.styles button"
            )),
              (i = []);
            for (e = 0, n = r.length; e < n; e += 1)
              (t = r[e]), i.push($(t).data("style-id"));
            return i;
          })()),
          (i = jQuery.unique(n)),
          (r = $("#details").data("style-limited-with-count")),
          $(e).data("sold-out")
            ? "sold_out"
            : f($(e).data("style-id"))
            ? "remove"
            : (a(n) && $("#details").data("style-limited")) ||
              (r > 1 && L(i, r))
            ? "style_limited"
            : "add"
        );
      ...
      (O = function (e) {
        var t, n;
        return (
          (t = $(e).attr("href") || $(e).attr("data-url")),
          this.Turbolinks.willVisit(t),
          B != null && B.abort(),
          A(e),
          o(e) === "add" &&
            ((n = t),
            (B = $.getScript(n, function (e, t, n) {
              return b();
            }))),
          $("a.selected, button.selected").removeClass("selected"),
          $(e).addClass("selected"),
          $('p[itemprop="model"]').html($(e).data("style-name")),
          $("article figure img").attr({ src: $(e).data("images").detail_url }),
          $(e).data("description") &&
            $(".description").html($(e).data("description")),
          $("#zoom-holder").css({
            background:
              "url(" + $(e).data("images").zoomed_url + ") 0 0  no-repeat",
          }),
          $("#zoom-holder").attr(
            "data-background-image",
            $(e).data("images").zoomed_url
          )
        );
      }),
      (A = function (e) {
        ...
        switch (o(e)) {
          ...
          case "remove":
            (t = c($(e).data("style-id"))),
              $("#cart-controls form, #cctrl form").replaceWith(
                $.nano($("script#cart-controls-remove").html(), { size_id: t })
              );
            break;
          case "style_limited":
            $("#cart-controls form, #cctrl form").replaceWith(
              $("script#cart-controls-limited").html()
            );
            break;
          case "add":
            $("#cart-controls form, #cctrl form").hasClass("add") ||
              $("#cart-controls form, #cctrl form").replaceWith(
                $("script#cart-controls-add").html()
              );
        }
        return b();
      }),
      (C = function () {
        return $("#cart-controls form, #cctrl form").replaceWith(
          $("script#cart-controls-sold-out").html()
        );
      }),
      (w = function () {
        var e, t, n, r;
        r = $("body.products ul.styles a, body.products ul.styles button");
        if (r[0] != null)
          return (
            r.attr("data-no-tubolink", "data-no-tubolink"),
            (t = (function () {
              var t, n, i;
              i = [];
              for (t = 0, n = r.length; t < n; t++)
                (e = r[t]), i.push($(e).data("images").detail_url);
              return i;
            })()),
            (n = new this.Loader(t, 1)),
            n.preloadAll(),
            r.off("click").on("click", function (e) {
              return O(this), e.preventDefault();
            })
          );
      }),
      (v = function () {
        return (
          $(".subtotal-container").addClass("highlight"),
          setTimeout(function () {
            return $(".subtotal-container").removeClass("highlight");
          }, 1e3)
        );
      }),
      (T = function () {
        ...
        if ($("#cart")[0] != null)
          return l()
            ...
            : ((n = u()),
              ...
              (r = n[1]),
              (e = n[2]),
              $("#items-count").html(t.replace("+", " ")),
              $("#subtotal").html(r),
              $("#subtotal_eu").length > 0 &&
                $("#subtotal_eu").html(
                  Supreme.addDelim(
                    Math.round(
                      Supreme.GBPtoEUR(r.replace("Â£", "").replace(",", ""))
                    ),
                    ","
                  ) + "&euro;"
                ),
      ...
      (S = function () {
        return (
          ...
          A(
            $(
              "body.products ul.styles a.selected, body.products ul.styles button.selected"
            )[0]
          )
        );
      }),
      (P = this.Turbolinks.visit),
      $(document).bind("page:change", function () {
        var e;
        return (e = $("ul#shop-scroller"))[0] != null && ((D = !1), H(e)), S();
      }),
      jQuery(function () {
        var e, t, n, r, i, s, o, a, f, l, c, v, m, g, y, b, w, x, T, N;
        if ((x = $("ul#shop-scroller"))[0] != null) {
          H(x);
          try {
            (c = document
              .querySelector("#shop-scroller li a")
              .getAttribute("href")),
              window._gaq.push(["_trackEvent", "first-product", c]);
          } catch (l) {
            a = l;
          }
        }
        return (
          ...
          $("body")
            ...
            .bind("cart:remove", function () {
              ...
              return (
                ...
                (i = r[1]),
                (t = r[2]),
                $("#cart-header #items-count").html(n.replace("+", " ")),
                $("#cart-total p span").html(i)
              );
            }),
          $("form#checkout_form")[0] != null &&
            (E(),
            floatingLabel.init({}),
            floatingLabel.evaluateInputs(),
            $(
              "form#checkout_form input[type=text], form#checkout_form input[type=email], form#checkout_form select"
            )
              .on("focus", function () {
            ...
            $("body").hasClass("us") &&
              $("#order_tel").mask("000-000-0000", { autoclear: !1 }),
            $("body").hasClass("us") &&
              $("#order_billing_country").val() === "USA" &&
              !$("body").hasClass("payment_page") &&
              $(document).on("keyup", "#order_billing_zip", function (e) {
                var t, n;
                t = n = $(this).val();
                if (n.length >= 4)
                  return (
                    ...
                    $.ajax({
                      url:
                        "https://supreme-images.s3.amazonaws.com/us-zipcodes/" +
                        n +
                        ".js",
            ...
            $("#credit_card_number").validateCreditCard(
              function (e) {
                var t;
                if (e.luhn_valid)
                  return (
            ...
            $("body").hasClass("us") &&
              ...
              $.validator.addMethod(
                "zipcode",
                function (e) {
                  return $("#order_billing_country").val() === "CANADA"
                    ? CANADA_ZIP.test(e.toUpperCase())
                    : $("#order_billing_country").val() === "MEXICO"
                    ? MEXICO_ZIP.test(e.toUpperCase())
                    : US_ZIP.test(e);
                },
                function () {
                  return $("#order_billing_country").val() === "CANADA"
                    ? "must be a valid canadian zipcode"
                    : "must be a 5 digit US zipcode";
                }
              ),
            ...
            (w = function (e) {
              ...
              return (
                e.preventDefault(),
                $("#checkout_form .button").val() ===
                "processing, please wait..."
                  ? !1
                  : $("#checkout_form .button").val() === "please wait..."
                  ? !1
                  : ((n = new Date().getTime() / 1e3),
                    M && n - M < 1
                      ...
                      : ((M = n),
                        $("#checkout_form").valid()
                          ? ($(".h-captcha").length > 0 && !t
                              ? hcaptcha.execute({
                                  rqdata: unescape($.cookie("hhhhhhhh")),
                                })
                              : $("form#checkout_form").attr(
                                  "data-verified"
                                ) !== "done"
                              ? ($.rails.disableFormElements(
                                  $("form#checkout_form")
                                ),
                                N())
                              : checkoutJsonCall(),
            ...
            (window.checkoutAfterCaptcha = function (e) {
              return (
                window.pookyCallback && window.pookyCallback(),
                (t = !0),
                $("form#checkout_form").attr("data-verified") !== "done"
                  ? ($.rails.disableFormElements($("form#checkout_form")), N())
                  : checkoutJsonCall(),
                !1
              );
            }),
            (b = function () {
              ...
              try {
                ...
                return (a = e), console.log(a);
              }
            }),
            (window.checkoutJsonCall = function (e) {
              return window.desktopCheckoutMod
                ? window.desktopCheckoutMod(window.originalCheckoutJsonCall, e)
                : window.originalCheckoutJsonCall(e);
            }),
            (window.originalCheckoutJsonCall = function (e) {
              var t;
              return (
                (t = $("#checkout_form .button").val()),
                t === "processing, please wait..."
                  ? !0
                  : ($("#checkout_form .button").val(
                      $("#checkout_form .button").attr("disable_with")
                    ),
                    n
                      ? !0
                      : ((n = !0),
                          ...
                          .done(function (e) {
                            ...
                            if (e.status === "failed" && e.errors)
                              return (
                                ...
                                e.errors.credit_card
                                  ? ($(".errors-placeholder").hide(),
                                    $("#cart-cc .errors").length
                                      ? $("#cart-cc .errors").text(
                                          e.errors.credit_card
                                        )
                                      : $("#cart-cc fieldset").prepend(
                                          '<div class="errors">' +
                                            e.errors.credit_card +
                                            "</div>"
                                        ))
                                ...
                                e.errors.order
                                  ? (e.errors.order.includes("terms")
                                      ? $(".has-checkbox.terms").addClass(
                                          "error"
                                        )
                                      : $(".has-checkbox.terms").removeClass(
                                          "error"
                                        ),
                                    typeof e["errors"]["order"] == "string" &&
                                      ($(".errors-placeholder").hide(),
                                      $("#cart-cc .errors").length
                                        ? $("#cart-cc .errors").text(
                                            e.errors.order
                            ...
                            if (e.status === "outOfStock")
                              return (
                                e.mp &&
                                  ga_track("Purchase Attempt", "mp_only", e.mp),
                                (location.href =
                                  window.location.origin + "/shop/cart")
                              );
                            if (e.status === "invalidQuantity")
                              return (location.href =
                                window.location.origin +
                                "/shop/cart?invalid_quantity=true");
                            if (e.status === "canada")
                              return (location.href =
                                window.location.origin +
                                "/shop/cart?canada=true");
                            if (e.status === "blocked_country")
                              return (location.href =
                                window.location.origin +
                                "/shop/cart?blocked_country=true");
                            if (e.status === "queued")
            ...
            (g = !1),
            (window.pollOrderStatus = function (e, t, i) {
              var s;
              return (
                (s = function () {
                  var o;
                  return (
                    ...
                    (d = setTimeout(function () {
                      return (
                        $(".checkout_free_shipping").remove(),
                        $("#processing_wait_note").addClass("show")
                      );
                    }, 5e3)),
                    (o = "/checkout/" + e + "/status.json"),
                    $.get(o)
                      .done(function (e) {
                        var o, u;
                        if (e.status === "queued")
                          return (g = window.setTimeout(s, 1e4));
                        if (e.status === "dup")
                          return (
                            window._gaq.push([
                              "_trackEvent",
                            ...
                            (location.href =
                              window.location.origin + "/shop/cart?dup=true")
                          );
                        if (e.status === "failed" && e.avs) {
                          window._gaq.push([
                            "_trackEvent",
                            "checkout-error",
                            "avs",
                          ...
                          if (e.status !== "failed" || !e.cvv) {
                            if (e.status === "outOfStock")
                              return (
                                e.mp &&
                                  ga_track("Purchase Attempt", "mp_only", e.mp),
                                typeof i != "undefined" && i(e),
                                (location.href =
                                  window.location.origin + "/shop/cart")
                              );
                            try {
                          ...
                          window._gaq.push([
                            ...
                            $(".errors-placeholder").hide(),
                            $("#cart-cc .errors").text(
                              "Please verify your credit card details"
                            ),
                            (n = !1),
                            b(),
                            $.rails.enableFormElements($("form#checkout_form")),
                            ...
                            $("#pay .button").removeClass("processing"),
                            p();
                          if (typeof i != "undefined") return i(e);
                        }
                      })
                      .fail(function (e, t, n) {
                        return (g = window.setTimeout(s, 2e4));
                      })
                  );
                }),
                (g = window.setTimeout(s, 1e4))
              );
            }),
            $(document).on("submit", "form#checkout_form", function (e) {
              return w(e);
            }),
            $(document).on("click", "checkout_form.checkout", function (e) {
              return w(e);
            }),
            $(document).on("click", "#store_credits .checkout", function (e) {
              return $("#pay").show(), $("#store_credits").fadeOut(100);
            }),
            (T = function () {
              var e, t, n, r, i, s, o;
              if ($("body").hasClass("payment_page")) return !1;
              window.update_shipping_cnt || (window.update_shipping_cnt = 0),
                (window.update_shipping_cnt += 1);
              if (window.update_shipping_cnt > 7) return !1;
              (e = $("form#checkout_form").serializeArray()), (t = {});
              for (n = 0, r = e.length; n < r; n++)
                (s = e[n]),
                  (i = s.name),
                  (o = s.value),
                  /number|verification_value|utf8|credit_card|riearmxa/.test(
                    i
                  ) || (t[i] = o);
              return (
                (t.cnt = window.update_shipping_cnt),
                  ...
                  success: function (e, t, n) {
                    ...
                    if ($("body").hasClass("us"))
                      return (
                        ...
                        $("body").append(
                          '<div id="surchage_info_tooltip">Canadian Surcharge covers all Goods and Services Tax (GST), Harmonized Sales Tax (HST) as well as Duty and Brokerage.<br><br>Canadian customers will not incur any additional charges upon delivery.</div>'
                        ),
            ...
            (i = function (e) {
              return (
                ...
                e.match(/^5[1-5]\d/)
                  ? "mastercard"
                  : e.match(/^4\d/) || e.match(/^4\d/)
                  ? "visa"
                  : e.match(/^3[47]\d/)
                  ? "american_express"
                  : e.match(/^35(28|29|[3-8]\d)\d$/)
                  ? "jcb"
                  : "UNKNOWN"
              );
            }),
            ($("#credit_card_type").length === 0 ||
              $("#credit_card_type").val() === "credit card") &&
              $(document).on("keyup", "#credit_card_number", function (e) {
                var t, n;
                e.preventDefault(), (n = $(this)), (t = i(n.val()));
                if (t === "UNKNOWN") {
                  $("#credit_card_number").unmask();
                  return;
                }
                return (
                  t === "american_express"
                    ? $("#credit_card_number")
                        .mask("9999 999999 99999", { autoclear: !1 })
                        .trigger("focus.mask")
                    : $("#credit_card_number")
                        .mask("9999 9999 9999 9999", { autoclear: !1 })
                        .trigger("focus.mask"),
                  $("#credit_card_verification_value")
                    .removeClass("visa")
                    .removeClass("master")
                    .removeClass("american_express")
                    .addClass(t)
                );
              }),
            $(document)
              .on("change", "#credit_card_type", function () {
                var e;
                return (
                  $("#credit_card_type").val() === "credit card"
                    ? ((e = i(field.val())),
                      e === "UNKNOWN"
                        ? $("#credit_card_number").unmask()
                        : e === "american_express"
                        ? $("#credit_card_number").mask("9999 999999 99999", {
                            autoclear: !1,
                          })
                    ...
                    : $("#credit_card_number").unmask(),
                  $("#credit_card_type").val() === "cod" ||
                  $("#credit_card_type").val() === "paypal"
                    ? ($("#cart-cc").hide(),
                      $("#credit_card_type").val() === "paypal" &&
                        $("#paypal_message").show(),
                      T())
              ...
              .trigger("change"),
            $(document).on("change", ".payment_selectors input", function () {
              return (
                $("#credit_card_type").val($(this).val()).trigger("change"),
                $(this).val() === "paypal"
                  ? ($("#cart-address").addClass("paypal-redirect-hide"),
                    $("#totals-container").addClass("paypal-redirect-hide"),
                    $("#terms-checkbox").addClass("paypal-redirect-hide"),
                    $("#cart-footer").addClass("paypal-redirect-hide"),
                    $(".payment_selectors").addClass(
                      "payment_selectors--pending"
                    ),
                    $("#checkout_form").addClass("paypal-redirect-progress"),
                    $.ajax({
                      type: "POST",
                      data: {
                      ...
                      url: "/checkout.json",
                      success: function (e, t, n) {
                        return e && e.status && e.status === "outOfStock"
                          ? (location.href =
                              window.location.origin + "/shop/cart")
                          : e.redirect_url
                  ...
                  : ($("#cart-address").removeClass("paypal-redirect-hide"),
                    $("#totals-container").removeClass("paypal-redirect-hide"),
                    $("#terms-checkbox").removeClass("paypal-redirect-hide"),
                    $("#cart-footer").removeClass("paypal-redirect-hide"),
                    $(".payment_selectors").removeClass(
                      "payment_selectors--pending"
                    ))
              );
            }),
            $(document).on("change", "#order_billing_country", function () {
              if (!$("body").hasClass("payment_page"))
                return (
                  $("#state_label").text(
                    $(this).val() === "CANADA" ? "province" : "state"
                  ),
                  $("#order_billing_state").html(
                    $("#states-" + $(this).val()).html()
                  )
                );
            }),
            ...
            $(document).on(
              "change",
              "#order_billing_country, #order_billing_state",
              T
            ),
            $(document).on("keyup", "#order_email", function (e) {
              var t, n;
              (n = /@.*SUP(.{8})/g), (t = n.test(e.target.value)), t && T();
            })),
          (r = function () {
            return (
              $("input#join-mailinglist").on("change", function () {
                var e;
                return (
                  (a = $("input#join-mailinglist")[0]),
                  (e = { commit: a.checked ? "subscribe" : "unsubscribe" }),
          ...
          (f = function () {
            ...
            return (
              ...
              $("#zoom-holder").css({ position: "absolute", left: e }).show(),
              $("#zoom-lens").on("click", s),
          ...
          (o = function (e) {
            ...
            return (
              ...
              (r = u - 75),
              (i = a - 75),
              (r = Math.min(Math.max(0, r), v - 150)),
              (i = Math.min(Math.max(0, i), v - 150)),
              $("#zoom-lens").css({ top: i, left: r }),
              $("body").addClass("zooming"),
              (t = $("#zoom-holder").css("background-image")),
              $("#zoom-holder").css({
                backgroundPosition: r * y + "px " + i * y + "px",
              }),
              $("#zoom-holder").css({ backgroundColor: "#fff" }),
              $("#zoom-holder").css({ backgroundImage: t }),
              e.stopPropagation()
            );
          }),
          ...
          $("#order_mailing_list, #eu_order_mailing_list").on(
            "ifChecked",
            function (e) {
          ...
          $("#mailinglist").on(
            ...
            (function (t) {
              return function (n) {
                var r;
                if (!t.Validator.valid("email")) return n.preventDefault(), !1;
                $("#_dx").val(new Date().getMonth()),
                  ga_track("event", "mailinglist", e.value),
                  $("#wrap").animate({ opacity: 0 });
                if (
                  $(".h-captcha").length > 0 &&
                  !window.captchaDoneForShopClosed
                ) {
                  n.preventDefault();
                  try {
                    return (
      ...
      (k = function (e, t, n) {
        return (
          e
            .css({
              position: "fixed",
              top: n.clientY - e.height() - 45,
              left: t.offset().left - e.width() / 2 - 3,
            })
            .show(),
          setTimeout(function () {
      ...
      (p = function () {
        return clearTimeout(d), $("#processing_wait_note").removeClass("show");
      }),
      (E = function () {
        var e, t;
        return (
          (t = $(".tax-tooltip")),
          (e = $("#estimated_sales_tax_tooltip")),
          clearTimeout(_),
          $(window).on(
            "scroll",
            (function (t) {
      ...
      (window.captchaDoneForShopClosed = !1),
      (window.subscribeAfterCaptchaForShopClosed = function () {
        return (
          (window.captchaDoneForShopClosed = !0), $("#mailinglist").submit()
        );
      }),
      $(document).ready(function () {
        var e, t, n, r, i, s, o, u, a;
        (e = $(".products.show #details .description")),
          e && e.height() >= 120 && e.addClass("scroll");
        if (document.querySelector("#cart-add select[name='size']")) {
          (u = document.querySelector("#cart-add select[name='size']")),
            (a = u.options),
            (s = document.createElement("b")),
            (o = document.createTextNode("sold out")),
            (i = u.parentNode),
            (s.className += "button sold-out"),
            s.appendChild(o),
            (a.length === 0 || a === void 0) && i.replaceChild(s, u);
          for (t = 0, n = a.length; t < n; t++) {
            r = a[t];
            if (r.value === "") return i.replaceChild(s, u), 0;
          }
        }
      });
  }.call(this),
            ...
            if (document.getElementsByTagName("iframe").length > 0)
              return (
                (document.getElementsByTagName("iframe")[0].title =
                  "CAPTCHA privacy and terms of conditions"),
  ...
  function () {
    ...
    (e = function () {
      var e;
      return (
        (e = $("#subject option:selected")),
        e.attr("data-req-order-id") && e.attr("data-req-order-id") === "y"
          ? $("#order_number_p").show()
          : $("#order_number_p").hide()
      );
    }),
      jQuery(function () {
        ...
        return (
          ...
          $("#form-mailinglist")[0] != null &&
            ($(".checkbox").iCheck({
              checkboxClass: "icheckbox_minimal",
              radioClass: "iradio_minimal",
              increaseArea: "20%",
            }),
            $("#order-mailing-list-fieldset .checkbox").on(
              "ifChecked",
              function (e) {
            ...
            $("#order-mailing-list-fieldset .checkbox").on(
              "ifUnchecked",
              function (e) {
                return $("#order-mailing-list-label label").removeClass(
                  "active"
                );
              }
            ),
            ...
            $("#form-mailinglist").on(
              ...
              (function (e) {
                return function (n) {
                  var r;
                  if (!e.Validator.valid("email"))
                    return n.preventDefault(), !1;
                  $("#_dx").val(new Date().getMonth()),
                    ga_track("event", "mailinglist", t.value),
                    $("#wrap").animate({ opacity: 0 });
                  if ($(".h-captcha").length > 0 && !window.captchaDone) {
                    n.preventDefault();
                    try {
                      return hcaptcha.execute(), !1;
                    } catch (r) {
                      n = r;
                    }
                  }
            ...
            $("input[name=mailinglist]").on(
              "click",
              (function (e) {
                return function (e) {
                  return $("input[name=mailinglist]:checked").val() === "jp"
                    ? ($("#order-mailing-list-fieldset").css(
                        "visibility",
                        "hidden"
                      ),
                      $("#order-mailing-list-label").css(
                        "visibility",
                        "hidden"
                      ),
                      $("#eu-order-mailing-list-fieldset").css(
                        "visibility",
                        "hidden"
                      ),
                      $("#eu-order-mailing-list-label").css(
                        "visibility",
                        "hidden"
                      ))
                    : ($("#order-mailing-list-fieldset").css(
          ...
          $("input#mailing_list, input#order_mailing_list").on(
            "click",
            function () {
              return (
                ...
                ga_track(
                  "event",
                  "update_mailinglist",
                  (this.checked ? "subscribe" : "unsubscribe") + this.id
                )
              );
            }
          ),
          (window.captchaDone = !1),
          (window.subscribeAfterCaptcha = function () {
            return (window.captchaDone = !0), $("#form-mailinglist").submit();
          }),
          $("#update_mailinglist_settings").on("click", function () {
            ...
            return (
              ...
              (e = (function (e) {
                return function () {
                  return $(e).css({ backgroundColor: "red" });
                };
              })(this)),
      ...
      return (
        $("#show-form")[0] != null &&
          $("#show-form").click(function () {
            return (
              $("#friend-mail span").css({ display: "flex" }),
              $("#embed_code").hide(),
              $("#show-embed").hide(),
              window.innerWidth < 480 && $(".more-random-link").hide(),
              $(this).hide(),
              !1
            );
          }),
        $("#show-embed")[0] != null &&
          $("#show-embed").click(function () {
            var e;
            return (
              (e = $("#embed_code input").val()),
              navigator.clipboard.writeText(e),
              $("#show-embed").text("Copied!"),
              $("#show-embed").css("background-color", "#ff0000"),
              $("#show-embed").css("border-color", "#ff0000"),
              setTimeout(function () {
                return (
                  $("#show-embed").text("embed video"),
                  $("#show-embed").css("background-color", ""),
                  $("#show-embed").css("border-color", "")
                );
              }, 5e3),
              !1
            );
        ...
        $("#cancel_email")[0] != null &&
          $("#cancel_email").click(function () {
            return (
              ...
              $("#show-form").show(),
              $("#show-embed").show(),
              window.innerWidth < 480 && $(".more-random-link").show(),
              !1
            );
          }),
        $("#wrap .scrollitem")[0] != null &&
          ((e =
            window
              .getComputedStyle(document.querySelector("body"), ":before")
              .getPropertyValue("content")
              .replace(/\"/g, "") === "mobile"),
          e
            ? $("#wrap .scrollitem").css("opacity", 1)
            : ((t = new this.Marque("#wrap .scrollitem")),
              $(document).one("page:change", function () {
                return t.stop();
              })),
          $("#wrap .scrollitem img").hover(function () {
            ...
            (t = $(this).attr("alt").split(": ")),
              (n = t[0]),
              (e = t[1]),
              typeof e == "undefined" && ((e = ""), (n = "")),
              (e =
                e.indexOf(",") !== -1
                  ? "<strong>" + e.replace(/,/, "</strong><br />")
                  : e);
            if (e !== "")
              return (
        ...
        $("form#friend-mail").on("submit", function (e) {
          ...
          return (
            e.preventDefault(),
            Validator.valid("to-email", "from-email")
              ? ((t = $("form#friend-mail").attr("action") + ".js"),
                $("#friend-mail span").hide(),
                $("#show-form").show(),
                $("#show-embed").show(),
                window.innerWidth < 480 &&
                  setTimeout(function () {
                    return (
                      $(".more-random-link").show(),
                      $(".friend-mail-confirmation").hide()
                    );
                  }, 3e3),
                $.post(t, $(this).serialize()).done(function (e) {
                  return ga_track(
                    "event",
                    "random",
                    "share",
                    $("footer .description h2").html()
                  );
                }))
              : !1
          );
  ...
  function () {
    ...
    (String.prototype.titleize = function () {
      ...
      (e = function (e) {
        return (
          (e["Product Color"] = $("p.style").text()),
          (e["Product Cost"] = $("p.price")
            .text()
            .replace(/[^\d\.]/, "")),
          (e.Currency = $("p.price span").data("currency")),
          (e["Product Name"] = $("#details h2").text()),
          (e.Category = $("#details h2").data("category")),
          (e["Sold Out?"] = $(".button.sold-out").length > 0),
          (e["Product Number"] = $("#details h2").data("ino")),
          (e["Release Week"] = $("#details h2").data("rw")),
          (e["Release Date"] = $("#details h2").data("rd")),
          (e.Season = $("#details h2").data("season")),
          e
        );
      }),
      ...
      (t.ga_track = function () {
        ...
        (n = [].slice.call(arguments)),
          (t = n.shift()),
          n[0] === "mp_only" && ((o = !0), n.shift()),
          (i = []),
          t.match(/ecommerce/)
            ? (typeof ga != "undefined" &&
                ga !== null &&
                ga("require", "ecommerce", "ecommerce.js"),
              typeof ga_eu != "undefined" &&
                ga_eu !== null &&
          ...
          typeof ga != "undefined" &&
            ga !== null &&
            !o &&
            ga.apply(ga, i.concat(n)),
          typeof ga_eu != "undefined" &&
            ga_eu !== null &&
            !o &&
            ga_eu.apply(ga, i.concat(n)),
          typeof mixpanel != "undefined" &&
            ...
            (s["Site Region"] = $("body").hasClass("us")
              ? "US"
              : $("body").hasClass("eu")
              ? "EU"
              : "JP"),
            t === "Add to Cart Attempt" &&
              ((s = e(s)),
              (s["Product Size"] = "Medium"),
              mixpanel.track("Add to Cart Attempt", s)),
            t === "Purchase Attempt" &&
              $.each(n[0], function (e, t) {
                return mixpanel.track("Purchase Attempt", $.extend(s, t));
              }),
            (t === "Purchase Success" || t === "Checkout View") &&
              mixpanel.track(t, $.extend(s, n[0])),
            t === "pageview" &&
              (location.pathname.match(/^\/shop\/?$/) ||
              location.pathname.match(/^\/shop\/all/)
                ? (location.pathname.match(/shop\/all\/[a-z]/i)
                    ? (s["Shop View Type"] = location.pathname
                        .split("/")
                        .slice(-1)[0]
                        .titleize())
                    : location.pathname.match(/shop\/all/i)
                    ? (s["Shop View Type"] = "All")
                    : (s["Shop View Type"] = "Tile"),
                  (r = "Shop View"))
                : location.pathname.match(/^\/shop/) &&
                  location.pathname.split("/").length > 3
                ? ((r = "Product View"), (s = e(s)))
                : !(
        ...
        if (typeof _gaq != "undefined" && _gaq !== null && !o)
          return (
            (t = t.replace("ecommerce:send", "trans")),
      ...
      (this.BaseImageController = (function () {
        function n(e, n, r, i) {
          ...
          (this.imageSelector = e),
            (this.index = n),
            (this.data = r),
            (this.caption = t(this.caption, this)),
            ...
            (this.showPrevImage = t(this.showPrevImage, this)),
            (this.showNextImage = t(this.showNextImage, this)),
            (this.showImageAtIndex = t(this.showImageAtIndex, this)),
            (this.showCursor = t(this.showCursor, this)),
            (this.setCursorImageLocation = t(
              this.setCursorImageLocation,
              this
            )),
            ...
            (f = function () {
              ...
              (n = this.data), (r = []);
              for (e = 0, t = n.length; e < t; e += 1)
                (o = n[e]), r.push(o.imageUrl);
              return r;
            }.call(this)),
            (l = this.data);
          for (u = 0, a = l.length; u < a; u += 1)
            (o = l[u]), o.zoomedImageUrl != null && f.push(o.zoomedImageUrl);
        ...
        return (
          ...
          (n.prototype.cursorForAction = function (e) {
            switch (e) {
              ...
              default:
                return this.showCursor("hidden");
            }
          }),
          (n.prototype.destroy = function () {
            return (
              this.imageViewer.destroy && this.imageViewer.destroy(),
              this.lightbox.hide(),
              $(window).off("keyup")
            );
          }),
            ...
            return (
              ...
              $.each(
                ...
                (function (e) {
                  return function (e, n) {
                    if (
                      n.zoomedImageUrl === t.attr("src") ||
                      n.imageUrl === t.attr("src")
                    )
                      return (r = n);
                  };
                })(this)
          ...
          (n.prototype.keyUpListener = function (e) {
            if (e.which === 27) {
              if (this.lightbox.isVisible()) return this.lightbox.hide();
            } else {
              if (e.which === 39) return this.showNextImage();
              if (e.which === 37) return this.showPrevImage();
              if (e.which === 32)
                return this.lightbox.isVisible()
                  ? this.lightbox.hide()
                  : this.tryShowingLightbox();
            }
          }),
          (n.prototype.newImageViewer = function (e, t) {
            return new BaseImageViewer(
              this,
              this.imageSelector,
              this.data,
              e,
          ...
          (n.prototype.setupCursor = function () {
            return $("#cursor-image")[0]
              ? (this.cursorImage = $("#cursor-image"))
              : (this.cursorImage = $('<span id="cursor-image" />')
                  .appendTo("body")
                  .css({ position: "absolute", zIndex: 1e4 })
                  .hide());
          }),
          (n.prototype.setCursorImageLocation = function (e) {
            var t;
            return (
              (t = this.cursorImage.attr("class")),
              t === "left"
          ...
          (n.prototype.showImageAtIndex = function (e, t) {
            return (
              ...
              this.lightbox.visible &&
                this.lightbox.showImageWithSrc(
                  this.data[this.index].zoomedImageUrl,
                  this.data[this.index].imageUrl,
                  t,
                  this.caption(e)
                ),
              this.pushImageState(),
          ...
          (n.prototype.showNextImage = function () {
            ...
            return this.hasNextImage()
              ...
              : ((this.isChangingImage = !0), this.showImageAtIndex(0));
          }),
          (n.prototype.showPrevImage = function () {
            ...
            return this.hasPrevImage()
              ? ((this.isChangingImage = !0),
                this.showImageAtIndex(this.index - 1))
              : ((this.isChangingImage = !0),
                this.showImageAtIndex(this.data.length - 1));
          }),
          ...
          (n.prototype.caption = function (e) {
            return this.data[this.index].caption;
          }),
          n
        );
      })());
  ...
  function () {
    ...
    (e = function (e, t) {
      var n, r, i;
      for (n = r = 0, i = e.length; r < i; n = r += 1)
        if (e[n] === t) return e.slice(n, 1);
      return e;
    }),
      (this.Loader = (function () {
        ...
        return (
          (n.prototype.arrayRotateToIndex = function (e, t) {
            return e.slice(t).concat(e.slice(0, t));
          }),
          (n.prototype.preloadNow = function (t, n) {
            var r, i, s;
            (t = this.arrayRotateToIndex(t, n)), this.cancel();
          ...
          (n.prototype.preloadAll = function () {
            ...
            (this.canceled = !1), (s = []);
            for (
              t = r = 0, i = Math.min(3, this.imageUrls.length);
              r < i;
              t = r += 1
            )
              (n = new Image()),
          ...
          (n.prototype.imgOnLoad = function (e) {
            this.loaded++, this.didLoad(e);
            if (!(this.imageUrls.length > 0)) return (this.allLoaded = !0);
            if (!this.canceled) return (e.src = this.imageUrls.shift());
          }),
          ...
          (n.prototype.cancel = function () {
            var e, t, n;
            this.canceled = !0;
            for (e = t = 0, n = this.images.length; t < n; e = t += 1)
          ...
          (n.prototype.loadImage = function (e) {
            ...
            e == null && (e = {}),
              (a = $.extend({ noFadeOut: !1, noFadeIn: !1 }, e)),
              (c = a.url),
              (f = a.selector),
              (r = a.loadingSelector),
            ...
            if (!o)
              return $(f).animate(
                ...
                (function (e) {
                  return function () {
                    if (!e.imageLoaded(i[0])) return $(r).addClass("loading");
                  };
                })(this)
              );
            s || $(f).css({ opacity: 0 });
            if (!this.imageLoaded(i[0])) return $(r).addClass("loading");
          }),
            ...
            return (
              ...
              t(100, function () {
                ...
                return (
                  (e = jwplayer(p).setup({
                    file:
                      "http://d3o425gsw3lvjf.cloudfront.net/" +
                      c.split(/[\\\/]/).pop(),
                    image:
                      "http://images.supremenewyork.com/assets/splash/" +
                      c
                  ...
                  jwplayer(p).onReady(
                    (function (e) {
                      return function () {
                        return (
                          $("#news-friend-mail").length > 0 &&
                            $("#friend-mail").addClass("show"),
                          $("div#friend-mail input[type='submit']").on(
                            "click",
                            function () {
                              if (Validator.valid("to-email", "from-email"))
                                return (
                                  (c =
                                    $(".embeddable_video").attr(
                                      "data-mailer-url"
                                    )),
                                  ...
                                  $.post(
                                    ...
                                    function (e) {
                                      return $("#friend-mail").html(
                                        "<fieldset><label>video sent to " +
                                          $("#to-email").val() +
                                          "</label></fieldset>"
                                      );
                                    }
                  ...
                  return function () {
                    ...
                    return (
                      ...
                      $(f)
                        ...
                        .removeClass("image-viewer-loading"),
                      o
                        .css({ opacity: 0 })
                        .animate({ opacity: 1 }, 200, function () {
                          if (n != null) return n(o[0]);
                        })
                    );
                  };
                })(this)
          ...
          (n.prototype.imageLoaded = function (e) {
            return (
              e &&
              (typeof e.complete != "undefined"
                ? e.complete
                : !isNaN(e.width + e.height) && e.width + e.height !== 0)
            );
          }),
          n
        );
      ...
      (this.LookBookImageController = (function (r) {
        function i(e, n, r, s) {
          (this.updateCount = t(this.updateCount, this)),
            ...
            this.imageViewer.setMousePositionActionsEnabled(!0),
            $(this).on(
              "image:changed",
              (function (e) {
                return function (t) {
                  return (
                    $("footer .description p").html(
                      $(
                        "#lookbook-items li:nth-of-type(" +
                          (e.index + 1) +
                          ") a"
                      ).data("caption")
                    ),
                    $("#lookbook-items li").removeClass("visible"),
                    $(
                      "#lookbook-items li:nth-child(" + (e.index + 1) + ")"
                    ).addClass("visible"),
                    $("#lookbook-items .controls > span").text(e.index + 1)
                  );
                };
              })(this)
            ),
            ...
            $("#lookbook-items ul a, #lookbook-items ul button")
              .attr("data-no-turbolink", "")
              .hover(this.thumbnailHovered)
              .click(this.thumbnailClicked),
            $("#img-main-link").on("click", this.mainImageClicked),
            $("#lookbook-items .controls .back").on(
              "click",
              this.showPrevImage
            ),
            $("#lookbook-items .controls .forward").on(
              "click",
              this.showNextImage
            );
        }
        return (
          ...
          (i.prototype.mainImageClicked = function (e) {
            ...
            try {
              window._gaq.push([
                ...
                "Lookbook",
                "zoom-click",
                "[" + this.index + "] " + this.data[this.index].caption,
              ]);
            } catch (t) {
              e = t;
            }
            return this.lightbox.tryShow(this.index), e.preventDefault(), !1;
          }),
          ...
          (i.prototype.showImageAtIndex = function (e, t) {
            var n;
            return (
              i.__super__.showImageAtIndex.call(this, e, t),
              (n = $($("#lookbook-items li button")[e])),
              $("footer .description p").html(n.data("caption")),
              this.updateCount(e)
            );
          }),
      ...
      (this.PreviewImageController = (function (r) {
        function i(e, n, r) {
          (this.pushImageState = t(this.pushImageState, this)),
            ...
            (window.preview_scale_ratio =
              window.screen.width > 321 ? 0.58 : 0.5),
            i.__super__.constructor.call(
              this,
              e,
              n,
              $(".preview-item #container[data-images]").data("images"),
              r
            ),
            ...
            this.mixpanel(),
            $(".preview-item #container[data-images] a").click(
              (function (e) {
                return function (e) {
                  return !1;
                };
        ...
        return (
          ...
          (i.prototype.mixpanel = function () {
            ...
            if ($("footer").data("color-name") && mixpanel)
              return (
                (e = $("html").hasClass("touch") ? "Mobile" : "Desktop"),
                (t = {
                  URL: location.pathname,
                ...
                window.preview_origin !== "View All" &&
                  (t["Grid Number"] = $("#container").data("grid-no")),
          ...
          (i.prototype.backControlClicked = function (e) {
            return this.showPrevImage(), e.preventDefault();
          }),
          (i.prototype.documentFetched = function () {
            return this.destroy(), $(window).off("resize");
          }),
          (i.prototype.forwardControlClicked = function (e) {
            return this.showNextImage(), e.preventDefault();
          }),
          ...
          (i.prototype.newImageViewer = function (e, t) {
            return (
              this.data[this.index].imageUrl.includes("mp4")
                ? $("#new_embed_row").fadeIn("slow")
                : $("#new_embed_row").hide(),
              BaseImageController.isTouchDevice()
                ? (new PreviewTouchImageViewer(
                    this,
                    this.imageSelector,
                    this.data,
                    e,
      ...
      (this.BaseLightbox = (function () {
        function e(e, n, r) {
          (this.data = e),
            ...
            this.options.imagePadding == null &&
              console.log(
                "WARNING: BaseLightbox initialized without imagePadding"
              ),
            (this.visible = !1),
            (this._scrollBigImageIntervalId = null);
        }
        return (
          (e.prototype.addLightboxToDom = function () {
            var e;
            return (
              $(
                '<div id="lightbox-container" class="' +
                  this.options.lightboxContainerClass +
                  '" style="display: none" aria-modal="true">\n  <div class="inner loading" tabindex="-1">\n      <img id="lightbox-image" />\n    </div>\n  </div>'
              ).appendTo($("body")),
              (e = (function (e) {
                return function () {
                  return $("#lightbox-container .inner").focus();
                };
              })(this)),
              setTimeout(e, 10)
            );
          ...
          (e.prototype.hide = function () {
            if (this.visible)
              return (
                ...
                $("#header").removeAttr("aria-hidden").attr("tabindex", -1),
                $("#nav").removeAttr("aria-hidden").attr("tabindex", -1),
                $("#header").find("a").removeAttr("tabindex"),
                $("#nav").find("a").removeAttr("tabindex"),
                document.body.classList.remove("lightbox")
              );
          }),
          (e.prototype.imageDidLoad = function (e) {
            return $("#lightbox-container").show(), this.imageLoader.didLoad(e);
          }),
          ...
          (e.prototype.setScrollingFromMousePosEnabled = function (e) {
            ...
            if (this._scrollBigImageIntervalId == null)
              return (this._scrollBigImageIntervalId = window.setInterval(
                (function (e) {
                  return function () {
          ...
          (e.prototype.shouldScrollFromMousePos = function () {
            return (
              this.visible && $(window).height() < $("#lightbox-image").height()
            );
          }),
          (e.prototype.show = function (e) {
            ...
            (this.visible = !0),
              ...
              $("#lightbox-container")
                ...
                .attr("role", "dialog")
                .attr("tabindex", -1)
                .attr("aria-labelledby", "lookbook_item_title")
                .focus(),
              $("#header").attr("aria-hidden", "true"),
              $("#nav").attr("aria-hidden", "true"),
              $("#header").find("a").attr("tabindex", -1),
            ...
            if (this.imageLoader != null && !this.imageLoader.allLoaded) {
              this.imageLoader.cancel(), (i = []), (s = this.data);
              for (t = 0, r = s.length; t < r; t += 1)
                (n = s[t]),
                  n.zoomedImageUrl != null && i.push(n.zoomedImageUrl);
              this.imageLoader.imageLoaded($("#lightbox-image")[0])
                ? this.imageLoader.preloadNow(i, e)
                : $("#lightbox-image").one(
                    "load",
                    (function (t) {
                      return function () {
            ...
            return (
              this.showImageWithSrc(
                this.data[e].zoomedImageUrl,
                this.data[e].imageUrl,
                !0,
                this.data[e].caption
              ),
          ...
          (e.prototype.showImageWithSrc = function (e, t, n, r) {
            return !this.options.scaleZoomedImage ||
              this.imageLoader.isPreloaded(e)
              ? this.imageLoader.loadImage({
                  ...
                  loadingCompletedCallback: (function (e) {
                    return function (t) {
                      return $(t).attr("alt", "" + r), e.imageDidLoad(t);
                    };
                  })(this),
                  noFadeOut: n,
                  noFadeIn: n,
                  ...
                  displayCompletedCallback: (function (t) {
                    return function (n) {
                      return t.imageLoader.loadImage({
                        ...
                        loadingSelector: "#lightbox-container .inner",
                        loadingCompletedCallback: function (e) {
                          return $(e).attr("alt", "" + r), t.imageDidLoad(e);
                        },
                        noFadeOut: !0,
                        noFadeIn: !0,
                      });
          ...
          (e.prototype.tryShow = function (e) {
            if (this.hasZoom(e) && !this.visible) return this.show(e);
          }),
          e
        );
      })());
